...
impl ChatWidget {
    ...
    pub(super) fn status_line_value(&mut self, item: StatusLineItem) -> Option<String> {
        match item {
            ...
            StatusLineItem::CodexVersion => Some(ANTEX_VERSION.to_string()),
    ...
    pub(super) fn status_surface_preview_value_for_item(
        ...
        let status_line_item = match item {
            StatusSurfacePreviewItem::AppName => return Some("antex".to_string()),
    ...
    pub(super) fn terminal_title_value_for_item(
        ...
        match item {
            TerminalTitleItem::AppName => Some("antex".to_string()),
