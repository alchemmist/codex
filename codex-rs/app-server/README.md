...
- `thread/context/read` — inspect the exact base instructions, current model-visible history items, and cached token usage for a loaded thread. This method is experimental.
