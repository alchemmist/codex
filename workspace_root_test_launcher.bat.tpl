...
if defined ANTEX_BAZEL_TEST_SKIP_FILTERS (
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$skipFilters = @();" ^
  "if (-not [string]::IsNullOrEmpty($env:ANTEX_BAZEL_TEST_SKIP_FILTERS)) { $skipFilters = @($env:ANTEX_BAZEL_TEST_SKIP_FILTERS -split ',' | Where-Object { $_ -ne '' }) };" ^
