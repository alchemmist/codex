...
pub use antex_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $ANTEX_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [antex_protocol::protocol::PatchApplyBeginEvent]
    /// and [antex_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [antex_protocol::protocol::ExecCommandBeginEvent]
    /// and [antex_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
