...
use antex_protocol::turn_input::CyberAccessProgram as CoreCyberAccessProgram;
use antex_protocol::user_input::ByteRange as CoreByteRange;
use antex_protocol::user_input::TextElement as CoreTextElement;
...
/// Requested cyber treatment for a ChatGPT-authenticated Antex turn.
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Antex's ResponsesAPI turn metadata.
    ///
