...
use antex_protocol::protocol::MisalignmentErrorDetails as CoreMisalignmentErrorDetails;
use antex_protocol::protocol::MisalignmentSteer as CoreMisalignmentSteer;
use antex_protocol::protocol::SessionSource as CoreSessionSource;
use antex_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use antex_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Antex-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, antex exec, antex app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Antex-generated turn IDs are UUIDv7.
    pub id: String,
