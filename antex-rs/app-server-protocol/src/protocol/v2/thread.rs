...
use antex_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use antex_protocol::protocol::TokenUsage as CoreTokenUsage;
use antex_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "antex_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
...
impl From<antex_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: antex_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> antex_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => antex_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => antex_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `antex_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
...
impl From<antex_protocol::ResponseUsageMetadata> for ResponseUsageMetadata {
    fn from(value: antex_protocol::ResponseUsageMetadata) -> Self {
        Self {
            amount: value.amount,
