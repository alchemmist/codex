...
use antex_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use antex_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use antex_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use antex_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use antex_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum Account {
    ...
    AmazonBedrock {
        ...
        uses_antex_managed_credentials: bool,
    },
}
    ...
    fn from(account: ProviderAccount) -> Self {
        match account {
            ...
            ProviderAccount::AmazonBedrock {
                uses_antex_managed_credentials,
            } => Self::AmazonBedrock {
                uses_antex_managed_credentials,
            },
        }
...
pub enum LoginAccountParams {
    ...
    Chatgpt {
        ...
        #[ts(rename = "codexStreamlinedLogin")]
    ...
    /// The access token must contain the same scopes that Antex-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Antex attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Antex attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Antex was previously using.
    ///
