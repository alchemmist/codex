...
use antex_protocol::items::McpToolCallError as CoreMcpToolCallError;
use antex_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use antex_protocol::mcp::McpServerInfo;
use antex_protocol::mcp::Resource as McpResource;
pub use antex_protocol::mcp::ResourceContent as McpResourceContent;
use antex_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use antex_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from antex_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from antex_protocol::protocol::McpStartupFailureReason {
...
v2_enum_from_core!(
    ...
    pub enum McpServerConnectionStatus from antex_protocol::mcp::McpServerConnectionStatus {
        NotStarted,
        Starting,
        Connected,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> antex_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => antex_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => antex_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => antex_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Antex turn when this elicitation was observed, if app-server could correlate one.
    ///
