...
use crate::TS;
use antex_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use antex_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use antex_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use antex_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use antex_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use antex_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use antex_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> antex_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<antex_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: antex_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            antex_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            antex_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            antex_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
