...
use antex_experimental_api_macros::ExperimentalApi;
use antex_extension_items::ExtensionItem;
pub use antex_extension_items::image_generation::ImageGenerationFailure;
pub use antex_extension_items::image_generation::ImageGenerationItem;
pub use antex_extension_items::sleep::SleepItem;
pub use antex_extension_items::web_search::WebSearchAction;
pub use antex_extension_items::web_search::WebSearchItem;
use antex_protocol::approvals::ExecApprovalKind as CoreExecApprovalKind;
use antex_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use antex_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use antex_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use antex_protocol::items::AgentMessageContent as CoreAgentMessageContent;
pub use antex_protocol::items::AgentMessageDelivery;
pub use antex_protocol::items::AsyncUserInputQuestion;
...
use antex_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use antex_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use antex_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use antex_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use antex_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: antex_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        antex_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        antex_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        antex_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        antex_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<antex_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: antex_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<antex_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: antex_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for antex_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
