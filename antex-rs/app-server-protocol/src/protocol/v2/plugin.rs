...
use crate::TS;
use antex_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use antex_protocol::protocol::SkillInterface as CoreSkillInterface;
use antex_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use antex_protocol::protocol::SkillScope as CoreSkillScope;
use antex_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
