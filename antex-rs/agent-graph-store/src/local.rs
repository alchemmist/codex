...
fn to_state_status(status: ThreadSpawnEdgeStatus) -> antex_state::DirectionalThreadSpawnEdgeStatus {
    match status {
        ThreadSpawnEdgeStatus::Open => antex_state::DirectionalThreadSpawnEdgeStatus::Open,
        ThreadSpawnEdgeStatus::Closed => antex_state::DirectionalThreadSpawnEdgeStatus::Closed,
    }
}
