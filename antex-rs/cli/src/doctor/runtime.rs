//! Captures how this Antex process was launched.
//!
...
/// Builds the process provenance row for the current Antex executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Antex package.");
    }
    check
}
