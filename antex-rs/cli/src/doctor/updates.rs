//! Diagnoses whether Antex update paths target the running installation.
//!
...
fn windows_store_update(
    ...
    if manifest.schema_version == 0
        ...
        || manifest.package_identity != "OpenAI.Antex"
    {
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @alchemmist/antex",
        InstallMethod::Bun => "bun install -g @alchemmist/antex",
        InstallMethod::VitePlus => "vp install -g @alchemmist/antex",
        InstallMethod::Pnpm => "pnpm add -g @alchemmist/antex",
...
mod tests {
    ...
    fn update_action_labels_install_contexts() {
        assert_eq!(
            ...
            "npm install -g @alchemmist/antex"
        );
        assert_eq!(
            update_action_label(&InstallContext {
