...
use antex_core_plugins::PluginMarketplaceUpgradeOutcome;
...
use antex_core_plugins::marketplace::marketplace_root_dir;
use antex_core_plugins::marketplace_add::MarketplaceAddOutcome;
use antex_core_plugins::marketplace_add::MarketplaceAddRequest;
use antex_core_plugins::marketplace_add::add_marketplace;
use antex_core_plugins::marketplace_remove::MarketplaceRemoveOutcome;
use antex_core_plugins::marketplace_remove::MarketplaceRemoveRequest;
...
#[derive(Debug, Parser)]
#[command(bin_name = "antex plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces Antex is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "antex plugin marketplace add",
...
#[derive(Debug, Parser)]
#[command(bin_name = "antex plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "antex plugin marketplace upgrade",
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "antex plugin marketplace remove",
...
impl JsonMarketplaceListOutput {
    fn from_marketplaces(
        marketplaces: Vec<antex_core_plugins::marketplace::Marketplace>,
...
async fn run_upgrade(
    ...
    builder: antex_core::config::ConfigBuilder,
) -> Result<()> {
    ...
    let reload_config: antex_core_plugins::ConfigLayerReload = std::sync::Arc::new(move || {
        runtime
