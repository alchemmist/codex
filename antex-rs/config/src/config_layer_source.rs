...
/// Provenance for one layer in the effective Antex configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.antex` directory.
    Project { dot_antex_folder: AbsolutePathBuf },
    ...
    match source {
        ...
        ConfigLayerSource::Project { dot_antex_folder } => {
            format!(
                ...
                dot_antex_folder.as_path().display()
            )
        }
