...
async fn sqlite_sink_filters_noisy_targets_without_dropping_useful_diagnostics() {
    ...
    tracing::debug!(
        target: "antex_rmcp_client::oauth",
    ...
    tracing::trace!(target: "antex_http_client::transport", "dropped-request-body");
    tracing::debug!(target: "antex_http_client::transport", "retained-request-diagnostic");
    tracing::trace!(target: "antex_api::sse", "dropped-sse-parent");
    tracing::trace!(target: "antex_api::sse::responses", "dropped-sse-payload");
    tracing::debug!(target: "antex_api::sse::responses", "retained-sse-diagnostic");
    tracing::trace!(target: "antex_state", "retained-trace");
    tracing::trace!(
        target: "antex_tui::streaming::controller",
    ...
    tracing::trace!(
        target: "antex_tui::streaming::table_holdback",
    ...
    tracing::trace!(
        target: "antex_tui::streaming::commit_tick",
        "retained-commit-tick-trace"
    );
    tracing::trace!(
        target: "antex_api::responses_websocket_timing",
    ...
    assert_eq!(
        ...
        vec![
            ...
            (
                "INFO",
                "antex_rmcp_client::oauth",
                Some("retained-codex-rmcp-client-info")
            ),
            (
                "DEBUG",
                "antex_http_client::transport",
                Some("retained-request-diagnostic")
            ),
            (
                "DEBUG",
                "antex_api::sse::responses",
                Some("retained-sse-diagnostic")
            ),
            ("TRACE", "antex_state", Some("retained-trace")),
            (
                "DEBUG",
                "antex_tui::streaming::controller",
                Some("retained-controller-debug"),
            ),
            (
                "DEBUG",
                "antex_tui::streaming::table_holdback",
                Some("retained-table-holdback-debug"),
            ),
            (
                "TRACE",
                "antex_tui::streaming::commit_tick",
