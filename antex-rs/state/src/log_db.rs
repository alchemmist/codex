...
//!
//! # async fn example(state_db: std::sync::Arc<antex_state::StateRuntime>) {
...
pub fn default_filter() -> Targets {
    Targets::new()
        ...
        .with_target("antex_rmcp_client", LevelFilter::INFO)
        ...
        .with_target("antex_otel.log_only", LevelFilter::OFF)
        .with_target("antex_otel.trace_safe", LevelFilter::OFF)
        ...
        .with_target("antex_tui::streaming::controller", LevelFilter::DEBUG)
        .with_target("antex_tui::streaming::table_holdback", LevelFilter::DEBUG)
}
    ...
    S: tracing::Subscriber + for<'a> LookupSpan<'a>,
{
    ...
    fn on_event(&self, event: &Event<'_>, ctx: tracing_subscriber::layer::Context<'_, S>) {
        ...
        // were over 30% of retained logs in measured high-fanout Antex environments.
...
mod tests {
    ...
    fn temp_antex_home() -> std::path::PathBuf {
    ...
    async fn sqlite_feedback_logs_match_feedback_formatter_shape() {
        let codex_home = temp_antex_home();
