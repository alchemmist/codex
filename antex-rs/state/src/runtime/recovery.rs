//! Backup-and-rebuild support for Antex runtime SQLite databases.
//!
//! Antex keeps several independent runtime SQLite databases under one SQLite
...
/// Move one Antex runtime SQLite database out of the way so that database can
