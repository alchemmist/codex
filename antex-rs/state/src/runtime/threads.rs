...
ON CONFLICT(id) DO NOTHING
        ...
        .bind(
            metadata
                .thread_source
                .as_ref()
                .map(antex_protocol::protocol::ThreadSource::as_str),
        )
...
mod tests {
    ...
    async fn apply_rollout_items_preserves_existing_git_branch_and_fills_missing_git_fields() {
        ...
        let items = vec![RolloutItem::SessionMeta(SessionMetaLine {
            ...
            git: Some(GitInfo {
                commit_hash: Some(antex_git_utils::GitSha::new("rollout-sha")),
    ...
    async fn apply_rollout_items_uses_override_updated_at_when_provided() {
        ...
        let items = vec![RolloutItem::EventMsg(EventMsg::TokenCount(
            antex_protocol::protocol::TokenCountEvent {
                info: Some(antex_protocol::protocol::TokenUsageInfo {
                    ...
                    last_token_usage: antex_protocol::protocol::TokenUsage::default(),
