...
use antex_code_mode_protocol::CodeModeSession;
use antex_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use antex_code_mode_protocol::CodeModeSessionDelegate;
use antex_code_mode_protocol::CodeModeSessionResultFuture;
use antex_code_mode_protocol::CodeModeToolKind;
use antex_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use antex_code_mode_protocol::ExecuteRequest;
use antex_code_mode_protocol::ExecuteToPendingOutcome;
use antex_code_mode_protocol::FunctionCallOutputContentItem;
use antex_code_mode_protocol::ImageDetail;
use antex_code_mode_protocol::NoopCodeModeSessionDelegate;
use antex_code_mode_protocol::RuntimeResponse;
use antex_code_mode_protocol::StartedCell;
use antex_code_mode_protocol::WaitOutcome;
use antex_code_mode_protocol::WaitRequest;
use antex_code_mode_protocol::WaitToPendingOutcome;
use antex_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: antex_protocol::ToolName {
