...
use crate::state_db;
use antex_file_search as file_search;
...
pub struct ThreadItem {
    ...
    pub section: Option<antex_state::ThreadSection>,
...
impl From<antex_state::Anchor> for Cursor {
    fn from(anchor: antex_state::Anchor) -> Self {
        let ts = anchor
            .ts
            .timestamp_nanos_opt()
...
///
/// Directory layout: `~/.antex/sessions/YYYY/MM/DD/rollout-YYYY-MM-DDThh-mm-ss-<uuid>.jsonl`
...
async fn find_thread_path_by_id_str_in_subdir(
    ...
    subdir: &str,
    id_str: &str,
    state_db_ctx: Option<&antex_state::StateRuntime>,
