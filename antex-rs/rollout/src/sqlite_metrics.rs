...
use antex_otel::ORIGINATOR_TAG;
use antex_otel::bounded_originator_tag_value;
use antex_state::DbTelemetry;
use antex_state::DbTelemetryHandle;
use antex_state::LOG_WRITE_BYTES_METRIC;
use antex_state::LOG_WRITE_MAX_ENTRY_BYTES_METRIC;
...
pub(crate) fn recorder(metrics: antex_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {
