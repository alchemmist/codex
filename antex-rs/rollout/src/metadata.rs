...
use antex_state::BackfillState;
use antex_state::BackfillStats;
use antex_state::BackfillStatus;
use antex_state::DB_ERROR_METRIC;
use antex_state::DB_METRIC_BACKFILL;
use antex_state::DB_METRIC_BACKFILL_DURATION_MS;
use antex_state::ExtractionOutcome;
use antex_state::ThreadMetadataBuilder;
use antex_state::apply_rollout_item;
use chrono::DateTime;
...
pub(crate) async fn backfill_sessions_with_lease(
    ...
    let metric_client = antex_otel::global();
