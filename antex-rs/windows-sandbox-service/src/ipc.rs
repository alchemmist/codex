...
use antex_windows_sandbox::ensure_sandbox_users_group;
use antex_windows_sandbox::run_elevated_provisioning_setup_with_retained_handles;
use antex_windows_sandbox::sandbox_setup_is_complete_with_settings;
...
pub(crate) const PIPE_NAME: &str = antex_windows_sandbox::SANDBOX_PROVISIONING_PIPE_NAME;
...
fn handle_request(
    ...
    let helper = std::env::current_exe()
        ...
        .with_file_name("antex-windows-sandbox-setup.exe");
