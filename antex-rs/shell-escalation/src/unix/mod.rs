...
//! `EscalateRequest` over the inherited `ANTEX_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `ANTEX_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use antex_protocol::approvals::EscalationPermissions;
pub use antex_protocol::approvals::ResolvedPermissionProfile;
