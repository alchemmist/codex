...
use antex_protocol::config_types::ToolResultLogConfig;
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            ...
            common: {
                ...
                auth.env_codex_api_key_present = self.metadata.auth_env.antex_api_key_env_present,
                auth.env_codex_api_key_enabled = self.metadata.auth_env.antex_api_key_env_enabled,
