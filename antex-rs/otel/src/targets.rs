pub(crate) const OTEL_TARGET_PREFIX: &str = "antex_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "antex_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "antex_otel.trace_safe";
