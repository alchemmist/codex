...
pub enum UpdateAction {
    ...
    BunGlobalLatest,
    /// Update via `vp install -g @alchemmist/antex@latest`.
    VitePlusGlobalLatest,
    /// Update via `pnpm add -g @alchemmist/antex@latest`.
    PnpmGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            ...
            UpdateAction::PnpmGlobalLatest => ("pnpm", &["add", "-g", "@alchemmist/antex"]),
            UpdateAction::BrewUpgrade => ("brew", &["upgrade", "--cask", "antex"]),
        ...
        assert_eq!(
            UpdateAction::from_install_context(&InstallContext {
                method: InstallMethod::Standalone {
                    ...
                    resources_dir: Some(native_release_dir.join("antex-resources")),
                },
                package_layout: None,
            }),
