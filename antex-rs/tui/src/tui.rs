...
/// Restore the terminal after Antex is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let scrollback = ScrollbackStrategy::detect(&antex_terminal_detection::terminal_info());
    ...
    /// terminal modes and stderr while keeping raw mode enabled, then re-applies Antex TUI modes
