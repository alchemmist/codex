...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Antex is rebuilding normal terminal scrollback, not an
...
use antex_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
