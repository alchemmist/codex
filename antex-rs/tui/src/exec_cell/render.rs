...
use antex_shell_command::bash::extract_bash_command;
use antex_utils_elapsed::format_duration;
...
mod tests {
    ...
    fn powershell_skill_read_snapshot() {
        ...
        let parsed = antex_shell_command::parse_command::parse_command(&command);
