    ...
    fn from(config: &Config) -> Self {
        Self {
            tui: Tui {
                ...
                startup_panel: config.tui_startup_panel.clone(),
                ...
                vim_mode_start: config.tui_vim_mode_start,
                show_vim_mode_indicator: config.tui_show_vim_mode_indicator,
                question_esc_back: config.tui_question_esc_back,
                raw_output_mode: config.tui_raw_output_mode,
                tmux_command_log: config.tui_tmux_command_log,
