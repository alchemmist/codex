...
pub(crate) enum AppEvent {
    ...
    /// Open the current thread in Antex Desktop.
    OpenDesktopThread {
        thread_id: ThreadId,
    },
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<antex_app_server_protocol::HooksListResponse, String>,
    },
    ...
    FetchExperimentalFeatures {
        ...
        response_tx: tokio::sync::oneshot::Sender<
            Result<Vec<antex_app_server_protocol::ExperimentalFeature>, String>,
        >,
    },
