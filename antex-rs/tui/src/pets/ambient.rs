//! Ambient terminal rendering for the Antex companion.
//!
...
impl AmbientPet {
    ...
    /// ANTEX_HOME cache, and records the terminal protocol support snapshot used
...
mod tests {
    ...
    #[test]
    fn notification_labels_match_antex_app_vocabulary() {
