...
//! raw markdown source.
//!
//! Markdown normalization uses these helpers to identify pipe-table structure
//! and fenced code blocks in raw source.
//!
//! ## Concepts
//!
...
//! state. Callers pair consecutive lines to confirm a table.
