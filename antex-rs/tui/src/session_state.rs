...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: antex_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<antex_protocol::openai_models::ReasoningEffort>,
