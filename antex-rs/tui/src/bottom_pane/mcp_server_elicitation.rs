...
use antex_app_server_protocol::McpElicitationEnumSchema;
use antex_app_server_protocol::McpElicitationPrimitiveSchema;
use antex_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use antex_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use antex_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use antex_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as APPROVAL_META_KIND_TOOL_SUGGESTION;
use antex_protocol::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use antex_protocol::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use antex_protocol::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use antex_protocol::mcp_approval_meta::TOOL_NAME_KEY;
use antex_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use antex_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
...
mod tests {
    ...
    fn switching_fields_clears_length_validation_flash() {
        ...
        overlay.handle_paste("x".repeat(antex_protocol::user_input::MAX_USER_INPUT_TEXT_CHARS + 1));
