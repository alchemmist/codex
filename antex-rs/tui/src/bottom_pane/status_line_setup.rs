...
pub(crate) enum StatusLineItem {
    ...
    /// Hostname of the machine running Antex.
    Hostname,
...
impl StatusLineItem {
    ...
    pub(crate) fn description(self) -> &'static str {
        match self {
            ...
            StatusLineItem::AntexVersion => "Codex application version",
    ...
    pub(crate) fn preview_item(self) -> StatusSurfacePreviewItem {
        match self {
            ...
            StatusLineItem::AntexVersion => StatusSurfacePreviewItem::AntexVersion,
