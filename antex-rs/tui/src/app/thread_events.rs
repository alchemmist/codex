...
impl ThreadEventStore {
            ...
            ServerNotification::Error(n)
                if self.active_turn_id.is_none()
                    ...
                    && n.error.codex_error_info
                        == Some(AppServerAntexErrorInfo::MisalignmentPolicyViolation) =>
            {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<antex_app_server_protocol::FileUpdateChange>> {
...
mod tests {
    ...
    use antex_app_server_protocol::HookEventName as AppServerHookEventName;
    use antex_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use antex_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use antex_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use antex_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use antex_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use antex_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use antex_app_server_protocol::HookScope as AppServerHookScope;
    use antex_app_server_protocol::HookStartedNotification;
    use antex_app_server_protocol::McpToolCallProgressNotification;
    ...
    fn thread_event_store_rebase_preserves_mcp_startup_notifications() {
        ...
        let notification = ServerNotification::McpServerStatusUpdated(
            antex_app_server_protocol::McpServerStatusUpdatedNotification {
                thread_id: Some(thread_id.to_string()),
                name: "sentry".to_string(),
                status: antex_app_server_protocol::McpServerStartupState::Failed,
