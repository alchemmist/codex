...
use super::*;
use antex_app_server_protocol::MisalignmentErrorDetails;
use antex_app_server_protocol::MisalignmentSteer;
use pretty_assertions::assert_eq;

fn policy_error() -> AppServerTurnError {
    AppServerTurnError {
        message: "Chat paused".into(),
        codex_error_info: Some(AppServerAntexErrorInfo::MisalignmentPolicyViolation),
...
fn error_notification(
    ...
    ServerNotification::Error(antex_app_server_protocol::ErrorNotification {
    ...
    for reject in [false, true] {
        ...
        app.enqueue_thread_notification(
            ...
            error_notification(
                ...
                "settings-update",
                AppServerTurnError {
                    codex_error_info: Some(AppServerAntexErrorInfo::BadRequest),
                    ..policy_error()
                },
            ),
        )
        ...
        let mut params: antex_app_server_protocol::TurnStartParams =
        ...
        assert_eq!(
            params,
            antex_app_server_protocol::TurnStartParams {
                thread_id: thread_id.to_string(),
                ...
                sandbox_policy: Some(antex_app_server_protocol::SandboxPolicy::ReadOnly {
