...
//! "leave the old title alone" or "clear the title Antex last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Antex manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Antex started managing the title.
