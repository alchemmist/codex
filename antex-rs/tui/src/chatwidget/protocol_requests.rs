...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: antex_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, antex_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                antex_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                antex_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                antex_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                antex_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                antex_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                antex_app_server_protocol::GuardianRiskLevel::Low => {
                    antex_protocol::approvals::GuardianRiskLevel::Low
                }
                antex_app_server_protocol::GuardianRiskLevel::Medium => {
                    antex_protocol::approvals::GuardianRiskLevel::Medium
                }
                antex_app_server_protocol::GuardianRiskLevel::High => {
                    antex_protocol::approvals::GuardianRiskLevel::High
                }
                antex_app_server_protocol::GuardianRiskLevel::Critical => {
                    antex_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    antex_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        antex_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    antex_app_server_protocol::GuardianUserAuthorization::Low => {
                        antex_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    antex_app_server_protocol::GuardianUserAuthorization::Medium => {
                        antex_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    antex_app_server_protocol::GuardianUserAuthorization::High => {
                        antex_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                antex_app_server_protocol::AutoReviewDecisionSource::Agent => {
