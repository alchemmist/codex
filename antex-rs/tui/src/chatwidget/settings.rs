...
impl ChatWidget {
    ...
    pub(crate) fn has_antex_backend_auth(&self) -> bool {
    ...
    pub(crate) fn update_account_state(
        ...
        self.has_antex_backend_auth = has_antex_backend_auth;
        self.bottom_pane
            .set_connectors_enabled(self.connectors_enabled());
        self.refresh_connector_mentions(/*force_refresh*/ false);
        self.bottom_pane
            .set_token_activity_command_enabled(has_antex_backend_auth);
        self.refresh_status_surfaces();
    }
