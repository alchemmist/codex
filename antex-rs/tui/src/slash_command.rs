...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Antex",
            ...
            SlashCommand::Permissions => "choose what Antex is allowed to do",
            ...
            SlashCommand::Logout => "log out of Antex",
