...
use antex_protocol::models::SandboxPermissions;
use antex_protocol::protocol::GuardianAssessmentOutcome;
use antex_protocol::protocol::GuardianCommandSource;
use antex_protocol::protocol::GuardianRiskLevel;
use antex_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(AntexAppMentionedEventRequest),
    AppUsed(AntexAppUsedEventRequest),
    HookRun(AntexHookRunEventRequest),
    Compaction(Box<AntexCompactionEventRequest>),
    Goal(Box<AntexGoalEventRequest>),
    ThreadHintStatus(Box<crate::thread_hint::ThreadHintStatusEventRequest>),
    TurnEvent(Box<AntexTurnEventRequest>),
    TurnSteer(AntexTurnSteerEventRequest),
    ArtifactOperation(AntexArtifactOperationEventRequest),
    CommandExecution(AntexCommandExecutionEventRequest),
    PluginMeasurement(AntexPluginMeasurementEventRequest),
    FileChange(AntexFileChangeEventRequest),
    McpToolCall(AntexMcpToolCallEventRequest),
    DynamicToolCall(AntexDynamicToolCallEventRequest),
    ControlToolCall(AntexControlToolCallEventRequest),
    CollabAgentToolCall(AntexCollabAgentToolCallEventRequest),
    WebSearch(AntexWebSearchEventRequest),
    ImageGeneration(AntexImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<AntexAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(AntexReviewEventRequest),
    PluginUsed(AntexPluginUsedEventRequest),
    PluginInstallRequested(AntexPluginInstallRequestedEventRequest),
    PluginInstalled(AntexPluginEventRequest),
    PluginUninstalled(AntexPluginEventRequest),
    PluginEnabled(AntexPluginEventRequest),
    PluginDisabled(AntexPluginEventRequest),
    PluginInstallFailed(AntexPluginInstallFailedEventRequest),
    ExternalAgentConfigImportCompleted(AntexOnboardingExternalAgentImportCompleteEventRequest),
    ExternalAgentConfigImportFailure(AntexOnboardingExternalAgentImportFailureEventRequest),
}

#[derive(Serialize)]
pub(crate) struct AntexArtifactOperationEventParams {
    ...
    pub(crate) runtime: AntexRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct AntexArtifactOperationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexArtifactOperationEventParams,
}

pub(crate) fn antex_artifact_operation_event_request(
    tracking: TrackEventsContext,
    operation: ArtifactOperation,
) -> AntexArtifactOperationEventRequest {
    AntexArtifactOperationEventRequest {
        event_type: "codex_artifact_operation",
        event_params: AntexArtifactOperationEventParams {
...
#[derive(Serialize)]
pub(crate) struct AntexAcceptedLineFingerprintsEventParams {
    pub(crate) event_type: &'static str,
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct AntexAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexAcceptedLineFingerprintsEventParams,
}
...
#[derive(Clone, Serialize)]
pub(crate) struct AntexRuntimeMetadata {
    #[serde(rename = "codex_rs_version")]
    pub(crate) antex_rs_version: String,
...
pub(crate) struct ThreadArchiveEventParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) runtime: Option<AntexRuntimeMetadata>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) thread_source: Option<ThreadSource>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) parent_thread_id: Option<String>,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Antex turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct AntexToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct AntexReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct AntexReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct AntexCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: AntexToolItemEventBase,
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AntexCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexPluginMeasurementEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    pub(crate) item_id: String,
...
#[derive(Serialize)]
pub(crate) struct AntexPluginMeasurementEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexPluginMeasurementEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: AntexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AntexFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AntexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AntexMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AntexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AntexDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexControlToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AntexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AntexControlToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexControlToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AntexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AntexCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: AntexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AntexWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: AntexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AntexImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexAppMetadata {
    pub(crate) connector_id: Option<String>,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AntexAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AntexAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AntexHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) product_client_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AntexHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct AntexCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: CodexAppServerClientMetadata,
    ...
    #[serde(rename = "codex_error_kind")]
    pub(crate) antex_error_kind: Option<AntexErrKind>,
    #[serde(rename = "codex_error_http_status_code")]
    pub(crate) antex_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct AntexCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexGoalEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: Option<String>,
    pub(crate) app_server_client: CodexAppServerClientMetadata,
    ...
    pub(crate) goal_status: antex_state::ThreadGoalStatus,
...
#[derive(Serialize)]
pub(crate) struct AntexGoalEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexGoalEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) root_turn_id: Option<String>,
    pub(crate) turn_trigger: Option<String>,
    #[serde(rename = "codex_turn_source")]
    pub(crate) antex_turn_source: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AntexTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexTurnSteerEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
...
#[derive(Serialize)]
pub(crate) struct AntexTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct AntexPluginMetadata {
    pub(crate) plugin_id: Option<String>,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AntexPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: AntexPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct AntexPluginInstallRequestedPluginMetadata {
    pub(crate) plugin_id: String,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AntexPluginInstallRequestedMetadata {
    pub(crate) suggestion_id: String,
    pub(crate) plugins: Vec<AntexPluginInstallRequestedPluginMetadata>,
...
#[derive(Serialize)]
pub(crate) struct AntexPluginInstallRequestedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexPluginInstallRequestedMetadata,
}

#[derive(Serialize)]
pub(crate) struct AntexPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct AntexPluginInstallFailedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: AntexPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct AntexPluginInstallFailedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexPluginInstallFailedMetadata,
}

#[derive(Serialize)]
pub(crate) struct AntexOnboardingExternalAgentImportCompleteMetadata {
...
#[derive(Serialize)]
pub(crate) struct AntexOnboardingExternalAgentImportCompleteEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexOnboardingExternalAgentImportCompleteMetadata,
}

#[derive(Serialize)]
pub(crate) struct AntexOnboardingExternalAgentImportFailureMetadata {
    pub(crate) import_id: String,
    pub(crate) source: String,
    pub(crate) provider_id: String,
    #[serde(rename = "type")]
...
#[derive(Serialize)]
pub(crate) struct AntexOnboardingExternalAgentImportFailureEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexOnboardingExternalAgentImportFailureMetadata,
}

#[derive(Serialize)]
pub(crate) struct AntexPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AntexPluginUsedMetadata,
}
...
pub(crate) fn antex_app_metadata(
    tracking: &TrackEventsContext,
    app: AppInvocation,
) -> AntexAppMetadata {
    AntexAppMetadata {
...
pub(crate) fn antex_plugin_metadata(plugin: PluginTelemetryMetadata) -> AntexPluginMetadata {
    antex_plugin_metadata_with_product_client_id(plugin, originator().value)
}

fn antex_plugin_metadata_with_product_client_id(
...
pub(crate) fn antex_plugin_install_requested_metadata(
    tracking: &TrackEventsContext,
    request: PluginInstallRequested,
) -> AntexPluginInstallRequestedMetadata {
    AntexPluginInstallRequestedMetadata {
        suggestion_id: request.suggestion_id,
        plugins: request
            .plugins
            .into_iter()
            .map(|plugin| AntexPluginInstallRequestedPluginMetadata {
...
pub(crate) fn antex_compaction_event_params(
    input: AntexCompactionEvent,
    session_id: String,
    ...
    AntexCompactionEventParams {
        ...
        status: input.status,
        antex_error_kind: input.antex_error_kind,
        antex_error_http_status_code: input.antex_error_http_status_code,
...
pub(crate) fn antex_goal_event_params(
    input: AntexGoalEvent,
    session_id: String,
    app_server_client: CodexAppServerClientMetadata,
    runtime: AntexRuntimeMetadata,
    thread_source: Option<ThreadSource>,
...
pub(crate) fn antex_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> AntexPluginUsedMetadata {
    let mcp_server_names = plugin
        .capability_summary
        .as_ref()
        .map(|summary| summary.mcp_server_names.clone());
    AntexPluginUsedMetadata {
        plugin: antex_plugin_metadata_with_product_client_id(
            plugin,
...
pub(crate) fn antex_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> AntexHookRunMetadata {
    AntexHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        product_client_id: Some(tracking.product_client_id.clone()),
...
pub(crate) fn current_runtime_metadata() -> AntexRuntimeMetadata {
    let os_info = os_info::get();
    AntexRuntimeMetadata {
        antex_rs_version: env!("CARGO_PKG_VERSION").to_string(),
