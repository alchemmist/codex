...
use crate::events::AntexAcceptedLineFingerprintsEventParams;
use crate::events::AntexAcceptedLineFingerprintsEventRequest;
use crate::events::AntexAppMentionedEventRequest;
use crate::events::AntexAppUsedEventRequest;
use crate::events::AntexCommandExecutionEventParams;
use crate::events::AntexCommandExecutionEventRequest;
use crate::events::AntexCompactionEventRequest;
use crate::events::AntexHookRunEventRequest;
use crate::events::AntexOnboardingExternalAgentImportFailureEventRequest;
use crate::events::AntexOnboardingExternalAgentImportFailureMetadata;
use crate::events::AntexPluginEventRequest;
use crate::events::AntexPluginInstallFailedEventRequest;
use crate::events::AntexPluginInstallFailedMetadata;
use crate::events::AntexPluginUsedEventRequest;
use crate::events::AntexReviewEventParams;
use crate::events::AntexReviewEventRequest;
use crate::events::AntexRuntimeMetadata;
use crate::events::AntexToolItemEventBase;
use crate::events::AntexTurnEventRequest;
...
use crate::events::antex_app_metadata;
use crate::events::antex_hook_run_metadata;
use crate::events::antex_plugin_metadata;
use crate::events::antex_plugin_used_metadata;
use crate::events::current_runtime_metadata;
use crate::events::subagent_thread_started_event_request;
use crate::facts::AnalyticsFact;
use crate::facts::AnalyticsJsonRpcError;
use crate::facts::AntexCompactionEvent;
use crate::facts::AntexErrKind;
...
use crate::facts::TurnAntexErrorFact;
...
use antex_app_server_protocol::ApprovalsReviewer as AppServerApprovalsReviewer;
use antex_app_server_protocol::AskForApproval as AppServerAskForApproval;
...
use antex_app_server_protocol::CollabAgentTool;
use antex_app_server_protocol::CollabAgentToolCallStatus;
use antex_app_server_protocol::CommandAction;
...
use antex_app_server_protocol::DynamicToolCallStatus;
use antex_app_server_protocol::GuardianApprovalReview;
use antex_app_server_protocol::GuardianApprovalReviewAction;
use antex_app_server_protocol::GuardianApprovalReviewStatus;
use antex_app_server_protocol::GuardianCommandSource as AppServerGuardianCommandSource;
use antex_app_server_protocol::ImageGenerationItem;
use antex_app_server_protocol::InitializeCapabilities;
use antex_app_server_protocol::InitializeParams;
use antex_app_server_protocol::ItemCompletedNotification;
use antex_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification;
use antex_app_server_protocol::ItemStartedNotification;
use antex_app_server_protocol::JSONRPCErrorError;
use antex_app_server_protocol::McpToolCallAppContext;
use antex_app_server_protocol::McpToolCallStatus;
use antex_app_server_protocol::NonSteerableTurnKind;
use antex_app_server_protocol::PatchApplyStatus;
use antex_app_server_protocol::PermissionsRequestApprovalParams;
use antex_app_server_protocol::RequestId;
use antex_app_server_protocol::RequestPermissionProfile;
use antex_app_server_protocol::SandboxPolicy as AppServerSandboxPolicy;
use antex_app_server_protocol::ServerNotification;
use antex_app_server_protocol::ServerRequest;
use antex_app_server_protocol::ServerResponse;
use antex_app_server_protocol::SessionSource as AppServerSessionSource;
use antex_app_server_protocol::SubAgentActivityKind;
...
use antex_app_server_protocol::ThreadSource as AppServerThreadSource;
use antex_app_server_protocol::ThreadStartResponse;
use antex_app_server_protocol::ThreadStatus as AppServerThreadStatus;
...
use antex_app_server_protocol::TurnError as AppServerTurnError;
...
use antex_app_server_protocol::TurnStatus as AppServerTurnStatus;
...
use antex_app_server_protocol::WebSearchItem;
use antex_login::default_client::DEFAULT_ORIGINATOR;
use antex_login::default_client::originator;
use antex_plugin::AppConnectorId;
use antex_plugin::PluginCapabilitySummary;
use antex_plugin::PluginId;
use antex_plugin::PluginTelemetryMetadata;
use antex_protocol::approvals::NetworkApprovalProtocol;
...
use antex_protocol::models::PermissionProfile as CorePermissionProfile;
use antex_protocol::protocol::AskForApproval;
use antex_protocol::protocol::HookEventName;
use antex_protocol::protocol::HookExecutionMode;
use antex_protocol::protocol::HookHandlerType;
use antex_protocol::protocol::HookRunStatus;
use antex_protocol::protocol::HookSource;
...
impl TurnAnalyticsMetadata for TestTurnMetadata {
    ...
    fn antex_turn_source(&self) -> Option<String> {
        None
    }
}
...
fn sample_runtime_metadata() -> AntexRuntimeMetadata {
    AntexRuntimeMetadata {
        antex_rs_version: "0.1.0".to_string(),
...
fn sample_turn_start_response(turn_id: &str) -> ClientResponsePayload {
    ClientResponsePayload::TurnStart(antex_app_server_protocol::TurnStartResponse {
        turn: Turn {
            id: turn_id.to_string(),
            items_view: antex_app_server_protocol::TurnItemsView::Full,
            items: vec![],
...
fn sample_turn_completed_notification(
    ...
    codex_error_info: Option<antex_app_server_protocol::CodexErrorInfo>,
) -> ServerNotification {
    ...
    reducer
        .ingest(
            AnalyticsFact::Initialize {
                ...
                params: InitializeParams {
                    client_info: ClientInfo {
                        name: "antex-tui".to_string(),
                        title: None,
                        version: "1.0.0".to_string(),
                    },
                    capabilities: None,
                },
                product_client_id: "antex-tui".to_string(),
                runtime: sample_runtime_metadata(),
                rpc_transport: AppServerRpcTransport::Stdio,
            },
            out,
...
fn sample_initialize_fact(connection_id: u64) -> AnalyticsFact {
    AnalyticsFact::Initialize {
        ...
        product_client_id: DEFAULT_ORIGINATOR.to_string(),
        runtime: AntexRuntimeMetadata {
            antex_rs_version: "0.99.0".to_string(),
    ...
    ServerRequest::PermissionsRequestApproval {
        ...
        params: PermissionsRequestApprovalParams {
            ...
            permissions: RequestPermissionProfile {
                network: Some(antex_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: None,
            },
...
fn sample_guardian_review_completed(
    ...
    ServerNotification::ItemGuardianApprovalReviewCompleted(
        ItemGuardianApprovalReviewCompletedNotification {
            ...
            decision_source: antex_app_server_protocol::AutoReviewDecisionSource::Agent,
...
fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
    ...
    let skill_path = PathBuf::from("/repo/root/.antex/skills/doc/SKILL.md");
    ...
    assert_eq!(path, ".antex/skills/doc/SKILL.md");
}

#[test]
fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/Users/abc/.antex/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
    let repo_root = PathBuf::from("/repo/root");
    let skill_path = PathBuf::from("/other/path/.antex/skills/doc/SKILL.md");
...
fn app_mentioned_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppMentioned(AntexAppMentionedEventRequest {
        event_type: "codex_app_mentioned",
        event_params: antex_app_metadata(
            &tracking,
            AppInvocation {
...
fn app_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppUsed(AntexAppUsedEventRequest {
...
fn accepted_line_fingerprints_event_serializes_expected_shape() {
    let event = TrackEventRequest::AcceptedLineFingerprints(Box::new(
        AntexAcceptedLineFingerprintsEventRequest {
            event_type: "codex_accepted_line_fingerprints",
            event_params: AntexAcceptedLineFingerprintsEventParams {
...
async fn analytics_flush_delivers_completed_turn_with_file_diff() {
    ...
    let auth_manager = antex_login::AuthManager::from_auth_for_testing(
        antex_login::AntexAuth::create_dummy_chatgpt_auth_for_testing(),
    );
...
fn compaction_event_serializes_expected_shape() {
    let event = TrackEventRequest::Compaction(Box::new(AntexCompactionEventRequest {
        event_type: "codex_compaction_event",
        event_params: crate::events::antex_compaction_event_params(
            AntexCompactionEvent {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
                ...
                antex_error_kind: None,
                antex_error_http_status_code: None,
...
fn command_execution_event_serializes_expected_shape() {
    let event = TrackEventRequest::CommandExecution(AntexCommandExecutionEventRequest {
        event_type: "codex_command_execution_event",
        event_params: AntexCommandExecutionEventParams {
            base: AntexToolItemEventBase {
                thread_id: "thread-1".to_string(),
                ...
                app_server_client: CodexAppServerClientMetadata {
                    product_client_id: "antex_tui".to_string(),
                    client_name: Some("antex-tui".to_string()),
...
fn review_event_serializes_expected_shape() {
    let event = TrackEventRequest::ReviewEvent(AntexReviewEventRequest {
        event_type: "codex_review_event",
        event_params: AntexReviewEventParams {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            item_id: None,
...
async fn compaction_event_ingests_custom_fact() {
    ...
    let parent_thread_id =
        antex_protocol::ThreadId::from_string("22222222-2222-2222-2222-222222222222")
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::Compaction(Box::new(
                AntexCompactionEvent {
                    ...
                    antex_error_kind: Some(AntexErrKind::ContextWindowExceeded),
                    antex_error_http_status_code: None,
                    active_context_tokens_before: 131_000,
...
fn subagent_thread_started_thread_spawn_serializes_thread_lineage() {
    let parent_thread_id =
        antex_protocol::ThreadId::from_string("11111111-1111-1111-1111-111111111111")
            .expect("valid thread id");
    let forked_from_thread_id =
        antex_protocol::ThreadId::from_string("22222222-2222-4222-8222-222222222222")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
fn subagent_thread_started_other_serializes_explicit_parent_thread_id() {
    let parent_thread_id =
        antex_protocol::ThreadId::from_string("33333333-3333-4333-8333-333333333333")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
async fn guardian_events_keep_thread_source_and_originator_with_explicit_turn_connection() {
    ...
    let mut events = Vec::new();
    let parent_thread_id =
        antex_protocol::ThreadId::from_string("44444444-4444-4444-4444-444444444444")
            .expect("valid parent thread id");
    ...
    assert_eq!(params.runtime.antex_rs_version, "0.1.0");
...
fn plugin_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::PluginUsed(AntexPluginUsedEventRequest {
        event_type: "codex_plugin_used",
        event_params: antex_plugin_used_metadata(&tracking, sample_plugin_metadata()),
    });
...
fn plugin_management_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstalled(AntexPluginEventRequest {
        event_type: "codex_plugin_installed",
        event_params: antex_plugin_metadata(sample_plugin_metadata()),
    });
...
fn plugin_install_failed_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstallFailed(AntexPluginInstallFailedEventRequest {
        event_type: "codex_plugin_install_failed",
        event_params: AntexPluginInstallFailedMetadata {
            plugin: antex_plugin_metadata(sample_plugin_metadata()),
...
fn plugin_management_event_keeps_plugin_id_local_when_remote_id_exists() {
    ...
    let event = TrackEventRequest::PluginInstalled(AntexPluginEventRequest {
        event_type: "codex_plugin_installed",
        event_params: antex_plugin_metadata(plugin),
    });
...
fn hook_run_event_serializes_expected_shape() {
    let tracking = test_tracking_context("thread-3", "turn-3");
    let event = TrackEventRequest::HookRun(AntexHookRunEventRequest {
        event_type: "codex_hook_run",
        event_params: antex_hook_run_metadata(
            &tracking,
            HookRunFact {
...
fn hook_run_metadata_maps_sources_and_statuses() {
    ...
    let system = serde_json::to_value(antex_hook_run_metadata(
        &tracking,
        HookRunFact {
    ...
    let project = serde_json::to_value(antex_hook_run_metadata(
        &tracking,
        HookRunFact {
    ...
    let cloud_requirements = serde_json::to_value(antex_hook_run_metadata(
        &tracking,
        HookRunFact {
            event_name: HookEventName::Stop,
    ...
    let unknown = serde_json::to_value(antex_hook_run_metadata(
        &tracking,
        HookRunFact {
...
fn hook_run_metadata_maps_stopped_status() {
    ...
    let stopped = serde_json::to_value(antex_hook_run_metadata(
        &tracking,
        HookRunFact {
            event_name: HookEventName::Stop,
            hook_source: HookSource::User,
            ...
            AnalyticsFact::Custom(CustomAnalyticsFact::SkillInvoked(SkillInvokedInput {
                ...
                invocations: vec![SkillInvocation {
                    ...
                    location: SkillInvocationLocation::Host {
                        path: skill_path,
                        scope: antex_protocol::protocol::SkillScope::User,
                    },
                    plugin_id: None,
...
async fn reducer_includes_plugin_ids_for_plugin_skill_invocations() {
    ...
    let tracking = test_tracking_context("thread-1", "turn-1");
    let skill_path =
        PathBuf::from("/Users/abc/.antex/plugins/cache/test/sample/skills/doc/SKILL.md");
...
fn external_agent_config_import_failure_event_serializes_expected_shape() {
    let event = TrackEventRequest::ExternalAgentConfigImportFailure(
        AntexOnboardingExternalAgentImportFailureEventRequest {
            event_type: "codex_onboarding_external_agent_import_failure",
            event_params: AntexOnboardingExternalAgentImportFailureMetadata {
                import_id: "import-1".to_string(),
                source: "app_server".to_string(),
                provider_id: "test-provider-42".to_string(),
                item_type: "PLUGINS".to_string(),
...
fn turn_event_serializes_expected_shape() {
    let event = TrackEventRequest::TurnEvent(Box::new(AntexTurnEventRequest {
        event_type: "codex_turn_event",
        event_params: crate::events::AntexTurnEventParams {
            thread_id: "thread-2".to_string(),
            session_id: "session-thread-2".to_string(),
            turn_id: "turn-2".to_string(),
            root_turn_id: Some("turn-2".to_string()),
            turn_trigger: Some("user".to_string()),
            antex_turn_source: Some("composer".to_string()),
...
async fn turn_lifecycle_emits_failed_turn_event() {
    ...
    reducer
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::TurnAntexError(Box::new(
                TurnAntexErrorFact::from_antex_err(
                    "thread-2".to_string(),
                    "turn-2".to_string(),
    ...
    reducer
        .ingest(
            AnalyticsFact::Notification(Box::new(sample_turn_completed_notification(
                ...
                Some(antex_app_server_protocol::CodexErrorInfo::BadRequest),
            ))),
            &mut out,
        )
        .await;
