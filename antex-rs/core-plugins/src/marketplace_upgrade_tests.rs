...
fn automatic_marketplace_git_ignores_inherited_repository_configuration() {
    const CHILD_HOME: &str = "ANTEX_MARKETPLACE_GIT_ISOLATION_CHILD_HOME";
    const CHILD_SOURCE: &str = "ANTEX_MARKETPLACE_GIT_ISOLATION_CHILD_SOURCE";
    ...
    let codex_home = project.join("antex-home");
