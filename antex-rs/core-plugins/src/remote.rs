...
use antex_http_client::RouteAwareRequestError;
...
const ANTEX_PRODUCT_SKU: &str = "codex";
...
fn ensure_chatgpt_auth(auth: Option<&AntexAuth>) -> Result<&AntexAuth, RemotePluginCatalogError> {
...
fn authenticated_request(
    ...
    request
        ...
        .header(OAI_PRODUCT_SKU_HEADER, ANTEX_PRODUCT_SKU)
}
