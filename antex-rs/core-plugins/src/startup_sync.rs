...
use antex_otel::CURATED_PLUGINS_STARTUP_SYNC_FINAL_METRIC;
use antex_otel::CURATED_PLUGINS_STARTUP_SYNC_METRIC;
use http::Method;
...
// Keep this comfortably above a normal sync attempt so we do not race another Antex process.
...
pub fn sync_openai_plugins_repo(
    ...
    let git_binary = antex_utils_path::system_executable("git");
