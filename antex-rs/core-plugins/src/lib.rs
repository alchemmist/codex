...
pub type LoadedPlugin = antex_plugin::LoadedPlugin<antex_config::McpServerConfig>;
pub type PluginLoadOutcome = antex_plugin::PluginLoadOutcome<antex_config::McpServerConfig>;
