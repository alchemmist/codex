pub use antex_backend_openapi_models::models::ConfigBundleResponse;
pub use antex_backend_openapi_models::models::CreditStatusDetails;
pub use antex_backend_openapi_models::models::DeliveredConfigToml;
pub use antex_backend_openapi_models::models::DeliveredManagedLayers;
pub use antex_backend_openapi_models::models::DeliveredRequirementsToml;
pub use antex_backend_openapi_models::models::DeliveredTomlFragment;
pub use antex_backend_openapi_models::models::PaginatedListTaskListItem;
pub use antex_backend_openapi_models::models::PlanType;
pub use antex_backend_openapi_models::models::RateLimitReachedKind;
pub use antex_backend_openapi_models::models::RateLimitStatusDetails;
pub use antex_backend_openapi_models::models::RateLimitStatusPayload;
pub use antex_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use antex_backend_openapi_models::models::SpendControlLimitDetails;
pub use antex_backend_openapi_models::models::TaskListItem;
...
pub(crate) struct AdditionalRateLimitWithNormalModel {
    #[serde(flatten)]
    pub details: antex_backend_openapi_models::models::AdditionalRateLimitDetails,
    pub normal_model_slug: Option<String>,
}

#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct AntexWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<AntexWorkspaceMessage>,
}

/// Authenticated Antex user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct AntexUserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct AntexWorkspaceMessage {
    pub message_id: String,
    pub message_type: AntexWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum AntexWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: AntexWorkspaceMessagesResponse = serde_json::from_value(serde_json::json!({
            "messages": [
                {
        ...
        assert_eq!(
            response,
            AntexWorkspaceMessagesResponse {
                messages: vec![
                    AntexWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: AntexWorkspaceMessageType::Headline,
                    ...
                    AntexWorkspaceMessage {
                        ...
                        message_type: AntexWorkspaceMessageType::Announcement,
                    ...
                    AntexWorkspaceMessage {
                        ...
                        message_type: AntexWorkspaceMessageType::Unknown,
