...
use antex_exec_server::EnvironmentConfigLayer;
use antex_exec_server::EnvironmentConfigLayerStack;
use antex_exec_server::EnvironmentConfigReadParams;
use antex_exec_server::EnvironmentConfigReadResponse;
...
async fn remote_environment_reads_projected_executor_config() -> anyhow::Result<()> {
    ...
    tokio::fs::create_dir_all(dot_antex.as_path()).await?;
    ...
    .await?;
    tokio::fs::write(
        dot_antex.join(CONFIG_TOML_FILE).as_path(),
        r#"
[future_environment]
