...
use antex_protocol::shell_environment::OPENAI_WORKLOAD_IDENTITY_CONTEXT_ENV_VAR;
...
pub(crate) struct PendingRouteAwareHttpBodyStream {
    ...
    pub(crate) response: antex_http_client::HttpResponse,
}
...
impl RouteAwareHttpRequestRunner {
    ...
    ) -> Result<(HttpRequestResponse, Option<PendingRouteAwareHttpBodyStream>), JSONRPCErrorError>
    {
        ...
        antex_otel::inject_span_w3c_trace_headers(&request_span, &mut headers);
