...
use antex_otel::OtelExporter;
use antex_otel::OtelHttpProtocol;
use antex_otel::OtelProvider;
use antex_otel::OtelSettings;
    ...
    let records = exported_logs(/*export_traces*/ false, |runtime, _, _| {
        runtime.block_on(async {
            ...
            let sandbox = crate::FileSystemSandboxContext::from_legacy_sandbox_policy(
                antex_protocol::protocol::SandboxPolicy::new_read_only_policy(), cwd.clone(),
...
fn exported_logs(
    ...
    let otel = OtelProvider::try_new(&OtelSettings {
        ...
        service_name: "antex-exec-server".to_string(),
