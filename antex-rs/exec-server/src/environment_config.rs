...
use antex_config::McpServerDisabledReason;
use antex_config::RequirementSource;
use antex_config::RequirementsLayerEntry;
use antex_config::compose_requirements_for_hostname;
use antex_config::format_config_layer_source;
use antex_config::host_name;
use antex_config::loader::LocalTomlLayerStack;
use antex_config::loader::load_local_config_layers;
use antex_exec_server_protocol::EnvironmentConfigLayer;
use antex_exec_server_protocol::EnvironmentConfigLayerStack;
use antex_exec_server_protocol::EnvironmentConfigReadParams;
use antex_exec_server_protocol::EnvironmentConfigReadResponse;
...
pub(crate) async fn read_environment_config(
    ...
    let codex_home = find_antex_home().map_err(|error| {
...
impl Environment {
    ...
    pub async fn discover_http_mcp_servers(
        ...
        for layer in response.config.layers {
            ...
            antex_config::merge_toml_values(&mut merged, &config);
        }
