...
"#,
    ...
    assert_eq!(
        ...
        Some(FeatureToml::Config(crate::GuardianV2ConfigToml {
            ...
            reasoning_effort: Some(antex_protocol::openai_models::ReasoningEffort::Minimal),
...
#[test]
fn antex_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::AntexHooks));
    assert_eq!(feature_for_key("antex_hooks"), Some(Feature::AntexHooks));
}
