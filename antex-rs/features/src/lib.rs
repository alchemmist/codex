...
pub enum Feature {
    ...
    /// Requires every reader of the Antex home to support compressed shared histories.
    ...
    Worktrees,
    /// Respect host system proxy settings for Antex-owned network clients.
    RespectSystemProxy,
    /// Enable collab tools.
    Collab,
