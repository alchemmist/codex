...
const LOCK_CONTENTION_EVENT_TARGET: &str = "antex_rmcp_client::oauth::refresh_lock::contention";
...
impl RefreshCredentialLock {
    ...
    async fn acquire_in(
        ...
        // Scope coordination to ANTEX_HOME alongside File and Secrets state. Direct keyring
