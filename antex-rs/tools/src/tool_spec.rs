...
use antex_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use antex_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
use antex_protocol::config_types::WebSearchUserLocationType;
use serde::Serialize;
