...
impl LocalThreadStoreConfig {
    pub fn from_config(config: &impl antex_rollout::RolloutConfigView) -> Self {
        Self {
    ...
    async fn thread_history_db(&self) -> ThreadStoreResult<&sqlx::SqlitePool> {
        ...
        self.thread_history_db
            .get_or_try_init(|| async {
                antex_state::open_thread_history_db(&self.config.sqlite).await
            })
            .await
        ...
        live_thread
            .append_items(&[
                ...
                RolloutItem::EventMsg(EventMsg::TokenCount(
                    antex_protocol::protocol::TokenCountEvent {
                        info: None,
                        rate_limits: None,
                    },
                )),
