...
use antex_rollout::first_rollout_content_match_snippet;
use antex_rollout::parse_cursor;
use antex_rollout::search_rollout_matches;
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = antex_rollout::plain_rollout_path(item.path.as_path());
