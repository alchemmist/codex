...
const RESPONSES_WEBSOCKET_TIMING_EVENT_TARGET: &str = "antex_api::responses_websocket_timing";
...
impl ResponsesWebsocketConnection {
    ...
    pub async fn stream_request(
        ...
        guardian_ticket: Option<&antex_protocol::guardian_ticket::GuardianTicket>,
...
fn emit_responses_websocket_timing_event(
    ...
    // `RUST_LOG='antex_api::responses_websocket_timing=trace'`.
    tracing::event!(
    ...
    fn direct_serialization_preserves_websocket_request_payload() {
        let api_request = ResponsesApiRequest {
            ...
            access_programs: Some(
                antex_protocol::turn_input::CyberAccessProgram::DaybreakBlue.into(),
            ),
