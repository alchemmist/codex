...
use antex_client::ByteStream;
use antex_client::StreamResponse;
use antex_protocol::ResponseUsageMetadata;
use antex_protocol::guardian_ticket::GUARDIAN_TICKET_HEADER;
use antex_protocol::guardian_ticket::GuardianTicket;
use antex_protocol::models::ResponseItem;
use antex_protocol::protocol::MisalignmentErrorDetails;
...
const X_ANTEX_TURN_STATE_HEADER: &str = "x-codex-turn-state";
...
fn header_turn_state_value_from_json(value: &Value) -> Option<String> {
    let headers = value.as_object()?;
    headers.iter().find_map(|(name, value)| {
        if name.eq_ignore_ascii_case(X_ANTEX_TURN_STATE_HEADER) {
            json_value_as_string(value)
        } else {
            None
        }
            ...
            Err(ApiError::MisalignmentPolicyViolation {
                ...
                assert_eq!(
                    ...
                    &Some(MisalignmentErrorDetails {
                        ...
                        steer: Some(antex_protocol::protocol::MisalignmentSteer {
