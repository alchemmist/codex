//! Resolve the release identity of the current Antex runtime.
...
impl BuildInfo {
    /// Return build information for the current Antex runtime.
    pub fn get() -> Self {
        BUILD_INFO
    ...
    /// Format the version for a user-facing Antex header.
