...
//!
//! `antex-rollout-trace` owns the event schema and writer behavior. This module
...
use antex_rollout_trace::ToolDispatchInvocation;
use antex_rollout_trace::ToolDispatchPayload;
use antex_rollout_trace::ToolDispatchRequester;
use antex_rollout_trace::ToolDispatchResult;
use antex_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        antex_turn_id: invocation.turn.sub_id.clone(),
