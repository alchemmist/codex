...
) -> antex_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => antex_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => antex_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => antex_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => antex_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => antex_tools::ToolUserShellType::Cmd,
    }
}
