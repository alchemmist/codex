...
use antex_sandboxing::policy_transforms::materialize_additional_permissions_with_context;
...
pub(crate) fn normalize_and_validate_additional_permissions(
    ...
    context: &antex_protocol::permissions::FileSystemSandboxPolicyContext<'_>,
...
pub(super) fn file_system_sandbox_policy_context_for_cwd<'a>(
    ...
    cwd: &'a PathUri,
) -> Option<antex_protocol::permissions::FileSystemSandboxPolicyContext<'a>> {
    ...
    if effective_permissions
        ...
        .is_some_and(|permissions| {
            permissions.entries.iter().any(|entry| {
                (matches!(
                    &entry.path,
                    antex_protocol::permissions::FileSystemPath::Special {
                        value: antex_protocol::permissions::FileSystemSpecialPath::Tmpdir,
                    }
                ) && context
                    ...
                    &entry.path,
                    antex_protocol::permissions::FileSystemPath::Special {
                        value: antex_protocol::permissions::FileSystemSpecialPath::ProjectRoots { .. },
