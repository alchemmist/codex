...
use antex_otel::GUARDIAN_REVIEW_COUNT_METRIC;
use antex_otel::GUARDIAN_REVIEW_DURATION_METRIC;
use antex_otel::GUARDIAN_REVIEW_TOKEN_USAGE_METRIC;
use antex_otel::GUARDIAN_REVIEW_TTFT_DURATION_METRIC;
...
mod tests {
    ...
    #[test_case(
        GuardianReviewedAction::NetworkAccess {
            protocol: antex_protocol::approvals::NetworkApprovalProtocol::Https,
            port: 443,
        },
        "network_access",
        BTreeMap::new();
