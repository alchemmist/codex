...
pub(crate) const AUTO_REVIEW_DENIED_ACTION_APPROVAL_DEVELOPER_PREFIX: &str =
    antex_guardian_context::MANUAL_APPROVAL_DEVELOPER_PREFIX;
...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: antex_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: antex_protocol::protocol::GuardianUserAuthorization,
