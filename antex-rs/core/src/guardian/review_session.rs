...
use antex_analytics::GuardianReviewAnalyticsResult;
use antex_analytics::GuardianReviewSessionAnalyticsParams;
use antex_analytics::GuardianReviewSessionKind;
use antex_extension_api::Instructions;
...
use crate::antex_delegate::run_antex_thread_interactive;
...
use antex_tools::normalize_output_image_detail;
...
struct GuardianReviewSessionReuseKey {
    ...
    root_authorization_version: Option<crate::antex_thread::GuardianAuthorizationVersion>,
...
impl GuardianReviewSessionReuseKey {
    fn from_spawn_config(
        ...
        Self {
            ...
            antex_linux_sandbox_exe: spawn_config.antex_linux_sandbox_exe.clone(),
...
async fn spawn_guardian_review_session(
    ...
    let (session, io) = Box::pin(run_antex_thread_interactive(
        spawn_config,
...
async fn run_review_on_session(
    ...
    let submission = review_session.io.submit_turn_input(
        TurnInputRequest::user_input(prompt_items.items)
            .with_thread_settings(antex_protocol::protocol::ThreadSettingsOverrides {
                ...
                collaboration_mode: Some(antex_protocol::config_types::CollaborationMode {
                    mode: antex_protocol::config_types::ModeKind::Default,
...
fn read_only_guardian_permission_profile(
    ...
    permission_profile
        ...
        .unwrap_or(PermissionProfile::External {
            network: antex_protocol::permissions::NetworkSandboxPolicy::Restricted,
        })
}

pub(crate) fn build_guardian_review_session_config(
    parent_config: &Config,
    live_network_config: Option<antex_network_proxy::NetworkProxyConfig>,
    active_model: &str,
