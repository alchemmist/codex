...
pub(crate) struct Session {
    ...
    pub(super) mcp_elicitation_reviewer_handle: OnceLock<antex_mcp::ElicitationReviewerHandle>,
    pub(super) mcp_elicitation_lifecycle_handle: OnceLock<antex_mcp::ElicitationLifecycle>,
...
pub(crate) struct SessionConfiguration {
    ...
    /// Directory containing all Antex state for this session.
...
impl SessionConfiguration {
    ...
    pub(super) fn thread_config_snapshot(
        ...
        ThreadConfigSnapshot {
            ...
            full_access: antex_protocol::protocol::has_full_access(
            ...
            if let Some(active_permission_profile) = next_configuration.active_permission_profile()
            {
                ...
                config.permissions.network = config
                    ...
                    .map_err(|err| ConstraintError::InvalidValue {
                        ...
                        requirement_source: antex_config::RequirementSource::Unknown,
                    })?;
                config
                    .permissions
...
async fn warm_plugins_and_skills_for_session_init(
    ...
    extensions: &antex_extension_api::ExtensionRegistry<Config>,
) -> Vec<SkillError> {
...
impl Session {
    ...
    pub(crate) async fn responses_metadata(
        ...
        request_kind: AntexResponsesRequestKind,
    ...
    pub(crate) async fn new(
        ...
        environment_selections: &[TurnEnvironmentSelection],
        config: Arc<Config>,
        user_instructions: Option<antex_extension_api::Instructions>,
        ...
        code_mode_session_provider: Arc<dyn antex_code_mode::CodeModeSessionProvider>,
        extensions: Arc<antex_extension_api::ExtensionRegistry<crate::config::Config>>,
        ...
        windows_sandbox_proxy_settings_mode: antex_sandboxing::WindowsSandboxProxySettingsMode,
            ...
            ForkPersistence::Copied => match &initial_history {
                InitialHistory::Resumed(resumed) => {
                    ...
                    resumed.history.first().and_then(|item| match item {
                        ...
                        {
                            antex_rollout::forked_from_ordinal_exclusive(
                                &meta.meta,
        ...
        thread_extension_init.insert(antex_extension_api::ThreadOriginator(
        ...
        let thread_extension_data = antex_extension_api::ExtensionData::new_with_init(
            thread_id.to_string(),
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let auth_mode = telemetry_auth
                .map(AntexAuth::auth_mode)
                .map(TelemetryAuthMode::from);
            let account_id = telemetry_auth.and_then(AntexAuth::get_account_id);
            let account_email = telemetry_auth.and_then(AntexAuth::get_account_email);
            ...
            let auth_env_telemetry = collect_auth_env_telemetry(
                ...
                auth_manager.antex_api_key_env_enabled(),
            );
            ...
            let mcp_server_names =
                antex_mcp::effective_mcp_servers(
            ...
            let session_extension_data =
                antex_extension_api::ExtensionData::new(session_id.to_string());
            ...
            for contributor in extensions.thread_lifecycle_contributors() {
                contributor.on_thread_start(antex_extension_api::ThreadStartInput {
            ...
            let session_start_source = match &initial_history {
                InitialHistory::Resumed(_) => antex_hooks::SessionStartSource::Resume,
                InitialHistory::New | InitialHistory::Forked(_) => {
                    antex_hooks::SessionStartSource::Startup
                }
                InitialHistory::Cleared => antex_hooks::SessionStartSource::Clear,
            };
