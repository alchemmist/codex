...
impl AgentControl {
    ...
    pub(crate) async fn shutdown_live_agent(&self, agent_id: ThreadId) -> AntexResult<String> {
    ...
    pub(crate) async fn close_agent(&self, agent_id: ThreadId) -> AntexResult<String> {
        let state = self.upgrade()?;
                ...
                if !thread.config_snapshot().await.ephemeral
                    ...
                    && let Err(err) = agent_graph_store
                        .set_thread_spawn_edge_status(
                            agent_id,
                            antex_agent_graph_store::ThreadSpawnEdgeStatus::Closed,
                        )
                        .await
                {
    ...
    pub(crate) async fn shutdown_agent_tree(&self, agent_id: ThreadId) -> AntexResult<String> {
