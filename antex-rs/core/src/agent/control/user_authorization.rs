...
use crate::antex_thread::GuardianRootMessage;
use crate::antex_thread::GuardianRootSnapshot;
    ...
    pub(crate) async fn root_user_authorization(
        ...
        let (messages, authorization_version) = if root_evidence.uses_thread_owned_context() {
            ...
            let mut messages = history
                .retained_context()
                .into_iter()
                .flat_map(antex_history::RetainedContext::ordered_entries)
                .filter_map(|entry| match entry {
                    antex_history::RetainedContextEntry::UserMessage(message) => {
                    ...
                    antex_history::RetainedContextEntry::VerifiedAnswer(answer) => {
                        antex_guardian_context::render_verified_answer(answer)
