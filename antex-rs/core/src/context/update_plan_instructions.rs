//! Omits checklist-tool guidance from Antex-owned prompts, before adding caller text.

/// Call only for Antex-owned prompt text; custom instructions must remain unchanged.
