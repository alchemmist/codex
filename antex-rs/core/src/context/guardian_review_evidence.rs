...
use crate::antex_thread::GuardianAuthorizationVersion;
    ...
    pub fn user_input_snapshot(
        ...
        match self.mode {
            GuardianContextMode::ThreadOwned => {
                let answers = history
                    .retained_context()
                    .map(antex_guardian_context::render_verified_answers);
    ...
    pub(crate) fn user_input_for_call(
        ...
        match self.mode {
            GuardianContextMode::ThreadOwned => history
                ...
                .and_then(antex_guardian_context::render_verified_answer),
