...
use antex_config::default_project_root_markers;
use antex_config::merge_toml_values;
use antex_config::project_root_markers_from_config;
...
impl LoadedAgentsMd {
    ...
    /// compile `antex-core` as a normal dependency without that configuration.
