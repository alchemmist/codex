...
use antex_protocol::models::ConfigurationReasoning;
...
fn drop_last_n_user_turns_preserves_prefix() {
    ...
    history.record_retained_context(&antex_history::RetainedContextEvent::VerifiedAnswer {
        answer: antex_history::VerifiedAnswer {
            turn_id: "checkpoint-turn".to_owned(),
            call_id: "ask-1".to_owned(),
            questions: vec![antex_history::VerifiedQuestionAnswer {
