...
command transformation live in the antex-sandboxing crate; this module keeps
...
pub use antex_protocol::models::SandboxPermissions;
...
pub(crate) struct ExecServerEnvConfig {
    pub(crate) policy: antex_exec_server::ExecEnvPolicy,
...
pub struct ExecRequest {
    ...
    pub(crate) exec_server_shell_snapshot: Option<antex_exec_server::ShellSnapshotRequest>,
...
) -> antex_protocol::error::Result<ExecToolCallOutput> {
