...
/// `antex_feedback::AntexFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// antex_core::feedback_tags!(model = "gpt-5", cached = true);
/// antex_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
