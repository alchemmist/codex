...
use antex_config::load_global_mcp_servers;
use antex_login::default_client::is_first_party_originator;
...
use antex_skills::SkillToolDependency;
...
pub(crate) async fn maybe_prompt_and_install_mcp_dependencies(
    ...
    if mentioned_skills.is_empty()
        || !config
            .features
            .enabled(antex_features::Feature::SkillMcpDependencyInstall)
    {
        return;
    }
