...
use super::X_ANTEX_INSTALLATION_ID_HEADER;
use super::X_ANTEX_PARENT_THREAD_ID_HEADER;
use super::X_ANTEX_TURN_METADATA_HEADER;
use super::X_ANTEX_WINDOW_ID_HEADER;
use super::X_OPENAI_SUBAGENT_HEADER;
use crate::AttestationContext;
use crate::AttestationProvider;
use crate::GenerateAttestationFuture;
use crate::responses_metadata::AntexResponsesMetadata;
use crate::test_support::TestAntexResponsesRequestKind;
use crate::test_support::responses_metadata as test_responses_metadata;
use antex_api::AgentIdentityTelemetry;
use antex_api::ApiError;
use antex_api::ResponseEvent;
...
use antex_model_provider::BearerAuthProvider;
use antex_model_provider::ModelProvider;
use antex_model_provider::ModelProviderFuture;
use antex_model_provider::ProviderAccountResult;
use antex_model_provider::ProviderAuthRecoveryMessages;
...
use antex_model_provider_info::CHATGPT_CODEX_BASE_URL;
use antex_model_provider_info::ModelProviderInfo;
use antex_model_provider_info::WireApi;
use antex_model_provider_info::create_oss_provider_with_base_url;
...
use antex_rollout_trace::ExecutionStatus;
...
use antex_rollout_trace::RolloutTrace;
    ...
    let output = client
        .compact_conversation_history(
            ...
            CompactConversationRequestSettings {
                effort: None,
                summary: antex_protocol::config_types::ReasoningSummary::None,
                service_tier: None,
            },
...
fn responses_lite_prefix_ids_track_thread_and_payload() -> anyhow::Result<()> {
    ...
    let build = |client: &ModelClient, prompt: &Prompt| {
        client.build_responses_request(
            ...
            &model,
            /*effort*/ None,
            antex_protocol::config_types::ReasoningSummary::None,
            /*service_tier*/ None,
    ...
    prompt.tools = vec![antex_tools::ToolSpec::Freeform(antex_tools::FreeformTool {
        name: "exec".to_string(),
        description: "Execute JavaScript.".to_string(),
        defer_loading: None,
        format: antex_tools::FreeformToolFormat {
...
fn started_inference_attempt(temp: &TempDir) -> anyhow::Result<InferenceTraceAttempt> {
    ...
    writer.append(RawTraceEventPayload::AntexTurnStarted {
...
fn output_message(id: &str, text: &str) -> ResponseItem {
    ResponseItem::Message {
        id: Some(antex_protocol::ResponseItemId::with_suffix("msg", id)),
...
fn build_ws_client_metadata_includes_window_lineage_and_turn_metadata() {
    ...
    for (client_key, metadata_key, expected) in [
        ...
        (
            X_ANTEX_WINDOW_ID_HEADER,
            "window_id",
            expected_window_id.as_str(),
        ),
        (
            X_ANTEX_PARENT_THREAD_ID_HEADER,
            "parent_thread_id",
...
impl ModelProvider for TestRecoveryProvider {
    ...
    fn auth(&self) -> ModelProviderFuture<'_, Option<AntexAuth>> {
        self.inner.auth()
    }
    ...
    fn recover_from_unauthorized(
        &self,
    ) -> ModelProviderFuture<'_, antex_protocol::error::Result<ProviderUnauthorizedRecovery>> {
...
#[test]
fn guardian_reviewer_uses_dedicated_endpoint_only_with_antex_backend_auth() {
    ...
    assert_eq!(
        model_client.responses_endpoint(
            Some(&AntexAuth::from_api_key("test-api-key")),
            "codex-auto-review",
        ),
        ResponsesEndpoint::Responses
    );
