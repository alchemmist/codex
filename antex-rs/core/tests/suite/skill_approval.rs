...
fn skill_script_command(test: &TestAntex, script_name: &str) -> Result<String> {
...
async fn wait_for_exec_approval_request(test: &TestAntex) -> Option<ExecApprovalRequestEvent> {
