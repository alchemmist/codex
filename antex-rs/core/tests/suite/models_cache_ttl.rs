...
use antex_models_manager::client_version_to_whole;
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    antex
        .start_or_steer_turn(
            ...
            .with_thread_settings(ThreadSettingsOverrides {
                ...
                approval_policy: Some(antex_protocol::protocol::AskForApproval::Never),
    ...
    let _ = wait_for_event(&antex, |event| matches!(event, EventMsg::TurnComplete(_))).await;
