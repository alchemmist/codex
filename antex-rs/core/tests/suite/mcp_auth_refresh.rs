...
use antex_mcp::CodexAppsToolsCache;
...
async fn hosted_plugin_runtime_ps_mcp_tool_calls_use_current_auth_manager_token() -> Result<()> {
    ...
    let expected_auth = AntexAuth::from_external_chatgpt_tokens(
        "header.e30.first",
        "test-account",
    ...
    let mut hosted_plugin_runtime_config = antex_mcp::hosted_plugin_runtime_mcp_server_config(
    ...
    *bearer_token_env_var = None;
    ...
    let runtime = McpRuntime::new(McpRuntimeInput {
        ...
        codex_apps_tools_cache_key: antex_mcp::codex_apps_tools_cache_key(Some(&expected_auth)),
