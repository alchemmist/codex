...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestAntexBuilder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestAntexBuilder {
    let apps_base_url = apps_base_url.into();
    test_antex()
        .with_auth(AntexAuth::create_dummy_chatgpt_auth_for_testing())
