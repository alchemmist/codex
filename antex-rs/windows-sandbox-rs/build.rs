...
const SETUP_BIN: &str = "antex-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "antex-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Antex binaries that link the
