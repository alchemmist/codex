...
use antex_utils_pty::JobObject;
use antex_windows_sandbox::ConsoleMode;
use antex_windows_sandbox::ErrorPayload;
use antex_windows_sandbox::ErrorStage;
use antex_windows_sandbox::ExitPayload;
use antex_windows_sandbox::FramedMessage;
use antex_windows_sandbox::IPC_PROTOCOL_VERSION;
use antex_windows_sandbox::LaunchDesktop;
use antex_windows_sandbox::LocalSid;
use antex_windows_sandbox::Message;
use antex_windows_sandbox::OutputPayload;
use antex_windows_sandbox::OutputStream;
use antex_windows_sandbox::PipeSpawnHandles;
use antex_windows_sandbox::ResizePayload;
use antex_windows_sandbox::SpawnReady;
use antex_windows_sandbox::SpawnRequest;
use antex_windows_sandbox::StderrMode;
use antex_windows_sandbox::StdinMode;
use antex_windows_sandbox::WindowsSandboxTokenMode;
use antex_windows_sandbox::allow_null_device;
use antex_windows_sandbox::create_readonly_token_with_caps_and_user_from;
use antex_windows_sandbox::create_workspace_write_token_with_caps_and_user_from;
use antex_windows_sandbox::decode_bytes;
use antex_windows_sandbox::encode_bytes;
use antex_windows_sandbox::get_current_token_for_restriction;
use antex_windows_sandbox::hide_current_user_profile_dir;
use antex_windows_sandbox::log_note;
use antex_windows_sandbox::read_frame;
use antex_windows_sandbox::read_handle_loop;
use antex_windows_sandbox::spawn_process_with_pipes;
use antex_windows_sandbox::to_wide;
use antex_windows_sandbox::token_mode_for_permission_profile;
use antex_windows_sandbox::write_frame;
use anyhow::Context;
use anyhow::Result;
use std::ffi::OsStr;
use std::fs::File;
...
struct IpcSpawnedProcess {
    ...
    conpty_owner: Option<antex_windows_sandbox::ConptyInstance>,
...
fn spawn_ipc_process(req: &SpawnRequest) -> Result<IpcSpawnedProcess> {
    ...
    let (pi, job, stdout_handle, stderr_handle, stdin_handle) = if req.tty {
        let (pi, mut conpty) = antex_windows_sandbox::spawn_conpty_process_as_user(
            h_token.raw(),
            &req.command,
            &effective_cwd,
            &req.env,
