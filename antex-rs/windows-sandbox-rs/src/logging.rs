...
pub fn current_log_file_path_for_antex_home(codex_home: &Path) -> PathBuf {
...
mod tests {
    ...
    #[test]
    fn current_log_file_path_for_antex_home_uses_sandbox_dir() {
        let codex_home = Path::new("antex-home");

        assert_eq!(
            current_log_file_path_for_antex_home(codex_home),
