...
/// Runtime operation requested by the model, a JS code cell, or Antex itself.
///
...
pub struct ToolCall {
    ...
    #[serde(rename = "started_by_codex_turn_id")]
    pub started_by_antex_turn_id: Option<AntexTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Antex tool boundary.
    ///
    ...
    /// they describe how Antex executed the request, not what the caller sent.
