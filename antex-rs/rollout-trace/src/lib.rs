//! Trace bundle format, writer, and reducer for Antex rollouts.
//!
//! This crate owns the trace schema. Hot-path Antex code should depend on the
...
/// Shared recorder context for inference attempts within one Antex turn.
...
pub use thread::ANTEX_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Antex tool boundary.
...
/// Append-only writer used by hot-path Antex instrumentation.
