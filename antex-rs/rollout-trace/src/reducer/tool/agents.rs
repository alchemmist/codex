use antex_protocol::protocol::CollabAgentInteractionBeginEvent;
use antex_protocol::protocol::CollabAgentInteractionEndEvent;
use antex_protocol::protocol::CollabAgentSpawnEndEvent;
use antex_protocol::protocol::CollabCloseBeginEvent;
use antex_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_antex_turn_id: String,
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.antex_turn_id.as_deref() == Some(antex_turn_id)
