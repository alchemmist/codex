...
pub struct RawTraceEvent {
    ...
    #[serde(rename = "codex_turn_id")]
    pub antex_turn_id: Option<AntexTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    #[serde(rename = "codex_turn_started")]
    AntexTurnStarted {
        #[serde(rename = "codex_turn_id")]
        antex_turn_id: AntexTurnId,
        thread_id: AgentThreadId,
    },
    #[serde(rename = "codex_turn_ended")]
    AntexTurnEnded {
        #[serde(rename = "codex_turn_id")]
        antex_turn_id: AntexTurnId,
    ...
    InferenceCancelled {
        ...
        /// before Antex stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why Antex stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how Antex began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how Antex finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
    ...
    AgentResultObserved {
        ...
        #[serde(rename = "child_codex_turn_id")]
        child_antex_turn_id: AntexTurnId,
...
impl RawTraceEventPayload {
    ...
    pub(crate) fn raw_payload_refs(&self) -> Vec<&RawPayloadRef> {
        match self {
            ...
            | RawTraceEventPayload::AntexTurnEnded { .. }
