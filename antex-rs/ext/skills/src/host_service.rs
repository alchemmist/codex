...
use antex_config::bundled_skills_enabled_from_stack;
...
use antex_skills::install_system_skills;
...
impl HostSkillsService {
    ...
    pub fn new_with_restriction_product(
        ...
        // The cache is shared by every process using this ANTEX_HOME. Disabled services filter
