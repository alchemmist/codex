...
use antex_protocol::approvals::GuardianAssessmentOutcome;
use antex_protocol::approvals::GuardianRiskLevel;
use antex_protocol::approvals::GuardianUserAuthorization;
...
pub enum ApprovalDecision {
    ...
    Allow,
    Reviewed(antex_protocol::protocol::ReviewDecision),
    AskUser,
}
...
pub trait SynchronousApprovalReviewer: Send + Sync {
    ...
    ) -> crate::ExtensionFuture<'_, antex_protocol::protocol::ReviewDecision>;
}
...
pub struct ApprovalDecisionInput<'a> {
    ...
    pub thread_id: ThreadId,
    pub thread_store: &'a ExtensionData,
    pub category: antex_protocol::openai_models::GuardianScope,
    pub approval_policy: antex_protocol::protocol::AskForApproval,
    pub approvals_reviewer: antex_protocol::config_types::ApprovalsReviewer,
