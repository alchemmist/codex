...
use antex_analytics::AntexGoalEvent;
use antex_analytics::GoalEventKind;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &antex_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(AntexGoalEvent {
