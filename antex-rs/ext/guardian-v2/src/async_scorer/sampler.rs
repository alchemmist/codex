...
use antex_api::ResponsesWebsocketConnection;
...
pub struct LunaSamplingRequest {
    ...
    pub guardian_ticket: Option<antex_protocol::guardian_ticket::GuardianTicket>,
...
impl LunaSampler {
    ...
    async fn responses_endpoint(&self) -> ResponsesEndpoint {
        ...
        if self.config.free_guardian
            ...
            && provider.supports_antex_backend_routes()
