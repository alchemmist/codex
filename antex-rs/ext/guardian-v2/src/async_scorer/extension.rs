...
use antex_core::context::GuardianReviewEvidence;
...
use antex_extension_api::ThreadOriginator;
...
use antex_login::AgentIdentityAuthPolicy;
...
use antex_protocol::openai_models::GuardianReviewMode;
...
use antex_protocol::protocol::has_full_access;
...
impl GuardianV2Extension {
    ...
    async fn score_tool(&self, input: ToolStartInput<'_>) {
        ...
        let antex_core::context::GuardianUserInputSnapshot {
