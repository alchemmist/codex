...
use antex_api::ImageBackground;
use antex_api::ImageEditRequest;
use antex_api::ImageGenerationRequest;
use antex_api::ImageQuality;
use antex_api::ImageUrl;
...
use antex_extension_api::ToolEnvironment;
...
use antex_extension_api::parse_tool_input_schema;
...
use antex_utils_image::PromptImageMode;
use antex_utils_image::load_for_prompt_bytes;
...
use crate::backend::AntexImagesBackend;
    ...
    async fn handle_call(
        ...
        .map_err(|error| {
            (
                ...
                usage_limit_failure(error.antex_error()),
            )
        })
