...
use antex_connectors_extension::ExecutorPluginConnectorProvider;
use antex_core::config::Config;
use antex_core_plugins::ExecutorPluginProvider;
use antex_core_plugins::loader::apply_configured_plugin_mcp_server_policies;
use antex_core_plugins::loader::configured_plugin_mcp_server_policies;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, antex_config::McpServerConfig)>,
