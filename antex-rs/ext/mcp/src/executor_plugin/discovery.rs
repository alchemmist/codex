...
use antex_core_plugins::manifest::parse_plugin_manifest_uri;
use antex_exec_server::CapabilityRootDiscovery;
use antex_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &antex_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, antex_config::McpServerConfig)> {
