...
use antex_mcp::McpEventNotification;
...
impl Fixture {
    pub async fn new() -> Result<Self> {
        ...
        let auth_value = AntexAuth::from_external_chatgpt_tokens(
            "header.e30.first",
            "account",
        ...
        let mut server_config = antex_mcp::hosted_plugin_runtime_mcp_server_config(
        ...
        *bearer_token_env_var = None;
        ...
        let runtime_input = || McpRuntimeInput {
            ...
            codex_apps_tools_cache_key: antex_mcp::codex_apps_tools_cache_key(Some(&auth_value)),
...
pub(super) struct StaticAuth(pub AntexAuth);
