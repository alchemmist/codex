...
pub use antex_file_system::WalkOptions;
pub use antex_file_system::WalkOutcome;
...
use antex_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        ...
        Self {
            shell: antex_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `antex-linux-sandbox` are command
...
mod tests {
    ...
    use antex_network_proxy::RemoteNetworkProxyLaunchConfig;
    use antex_protocol::config_types::WindowsSandboxProxySettingsMode;
    ...
    fn exec_params_keeps_proxy_launch_separate_from_sandbox_facts() {
        ...
        let params = ExecParams {
            ...
            metadata: Some(ExecMetadata {
                thread_id: Some(antex_protocol::ThreadId::new()),
