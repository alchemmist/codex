...
use antex_app_server_protocol::RemoteControlDisableParams;
use antex_app_server_protocol::RemoteControlDisableResponse;
use antex_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<antex_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_ANTEX_HOME: &str = "/tmp/antex-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "antex_app_server/1.2.3",
                    "codexHome": TEST_ANTEX_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
