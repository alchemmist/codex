...
use antex_app_server::AppServerRuntimeOptions;
use antex_app_server::AppServerTransport;
use antex_app_server::AppServerWebsocketAuthSettings;
use antex_app_server::PluginStartupTasks;
use antex_app_server::RemoteControlStartupMode;
use antex_app_server::run_main_with_transport_options;
...
use antex_app_server_protocol::RemoteControlClient;
use antex_app_server_protocol::RemoteControlClientsListOrder;
use antex_app_server_protocol::RemoteControlClientsListParams;
use antex_app_server_protocol::RemoteControlClientsListResponse;
use antex_app_server_protocol::RemoteControlClientsRevokeParams;
use antex_app_server_protocol::RemoteControlClientsRevokeResponse;
use antex_app_server_protocol::RemoteControlConnectionStatus;
use antex_app_server_protocol::RemoteControlDisableResponse;
use antex_app_server_protocol::RemoteControlEnableResponse;
...
use antex_app_server_protocol::RemoteControlPairingStatusResponse;
use antex_app_server_protocol::RemoteControlStatusChangedNotification;
use antex_app_server_protocol::RemoteControlStatusReadResponse;
...
use antex_state::RemoteControlEnrollmentRecord;
...
async fn explicit_remote_control_startup_fails_when_disabled_by_requirements() -> Result<()> {
    ...
    let result = timeout(
        ...
        run_main_with_transport_options(
            Arg0DispatchPaths {
                antex_self_exe: Some(std::env::current_exe()?),
