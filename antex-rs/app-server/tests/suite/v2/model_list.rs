...
use antex_app_server_protocol::Model;
use antex_app_server_protocol::ModelListParams;
use antex_app_server_protocol::ModelListResponse;
use antex_app_server_protocol::ModelServiceTier;
use antex_app_server_protocol::ModelUpgradeInfo;
use antex_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        antex_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
