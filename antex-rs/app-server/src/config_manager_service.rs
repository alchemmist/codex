...
use antex_app_server_protocol::Config as ApiConfig;
...
use antex_app_server_protocol::OverriddenMetadata;
...
use antex_config::ShellEnvironmentPolicyFilterRepresentation;
use antex_config::config_toml::ConfigToml;
use antex_config::is_structured_feature_path;
use antex_config::merge_toml_values;
use antex_config::shell_environment_filter_entry;
use antex_config::validate_shell_environment_policy_filter_config;
use antex_core::config::deserialize_config_toml_with_base;
use antex_core::config::edit::ConfigEdit;
use antex_core::config::edit::ConfigEditsBuilder;
use antex_core::config::validate_feature_requirements_for_config_toml;
use antex_core::path_utils;
use antex_core::path_utils::SymlinkWritePaths;
use antex_core::path_utils::resolve_symlink_write_paths;
use antex_core::path_utils::write_atomically;
...
fn override_message(layer: &ConfigLayerSource) -> String {
    match layer {
        ...
        ConfigLayerSource::Project { dot_antex_folder } => format!(
            "Overridden by project config: {}/{CONFIG_TOML_FILE}",
            dot_antex_folder.display(),
        ),
