...
use antex_app_server_protocol::AccountRateLimitsUpdatedNotification;
use antex_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use antex_app_server_protocol::AuthRecoveryNotification;
use antex_app_server_protocol::CodexErrorInfo as V2AntexErrorInfo;
use antex_app_server_protocol::CommandAction as V2ParsedCommand;
use antex_app_server_protocol::CommandExecutionApprovalDecision;
use antex_app_server_protocol::CommandExecutionPresentation;
use antex_app_server_protocol::CommandExecutionRequestApprovalParams;
use antex_app_server_protocol::CommandExecutionRequestApprovalResponse;
use antex_app_server_protocol::CommandExecutionSource;
use antex_app_server_protocol::CommandExecutionStatus;
use antex_app_server_protocol::DeprecationNoticeNotification;
use antex_app_server_protocol::DynamicToolCallParams;
use antex_app_server_protocol::EnvironmentConnectionNotification;
use antex_app_server_protocol::ErrorNotification;
use antex_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use antex_app_server_protocol::FileChangeApprovalDecision;
use antex_app_server_protocol::FileChangeRequestApprovalParams;
use antex_app_server_protocol::FileChangeRequestApprovalResponse;
use antex_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use antex_app_server_protocol::GuardianWarningNotification;
use antex_app_server_protocol::HookCompletedNotification;
use antex_app_server_protocol::HookStartedNotification;
use antex_app_server_protocol::ItemCompletedNotification;
use antex_app_server_protocol::ItemStartedNotification;
use antex_app_server_protocol::McpServerElicitationAction;
use antex_app_server_protocol::McpServerElicitationRequestParams;
use antex_app_server_protocol::McpServerElicitationRequestResponse;
use antex_app_server_protocol::McpServerStartupState;
use antex_app_server_protocol::McpServerStatusUpdatedNotification;
use antex_app_server_protocol::ModelReroutedNotification;
use antex_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use antex_app_server_protocol::ModelVerificationNotification;
use antex_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use antex_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use antex_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use antex_app_server_protocol::PermissionsRequestApprovalParams;
use antex_app_server_protocol::PermissionsRequestApprovalResponse;
use antex_app_server_protocol::RawResponseCompletedNotification;
use antex_app_server_protocol::RawResponseItemCompletedNotification;
...
use antex_app_server_protocol::StrictReviewRequiredNotification;
use antex_app_server_protocol::ThreadGoalUpdatedNotification;
use antex_app_server_protocol::ThreadItem;
use antex_app_server_protocol::ThreadRealtimeClosedNotification;
use antex_app_server_protocol::ThreadRealtimeErrorNotification;
use antex_app_server_protocol::ThreadRealtimeItemAddedNotification;
use antex_app_server_protocol::ThreadRealtimeItemCompletedNotification;
use antex_app_server_protocol::ThreadRealtimeItemStartedNotification;
use antex_app_server_protocol::ThreadRealtimeItemTranscriptDeltaNotification;
use antex_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use antex_app_server_protocol::ThreadRealtimeSdpNotification;
use antex_app_server_protocol::ThreadRealtimeStartedNotification;
use antex_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use antex_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use antex_app_server_protocol::ThreadRollbackResponse;
use antex_app_server_protocol::ThreadSettingsUpdatedNotification;
use antex_app_server_protocol::ThreadStatus;
use antex_app_server_protocol::ThreadTokenUsage;
use antex_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use antex_app_server_protocol::ToolRequestUserInputOption;
use antex_app_server_protocol::ToolRequestUserInputParams;
use antex_app_server_protocol::ToolRequestUserInputQuestion;
use antex_app_server_protocol::ToolRequestUserInputResponse;
use antex_app_server_protocol::Turn;
use antex_app_server_protocol::TurnCompletedNotification;
use antex_app_server_protocol::TurnDiffUpdatedNotification;
...
use antex_app_server_protocol::TurnModerationMetadataNotification;
use antex_app_server_protocol::TurnPlanStep;
use antex_app_server_protocol::TurnPlanUpdatedNotification;
use antex_app_server_protocol::TurnStartedNotification;
use antex_app_server_protocol::TurnStatus;
use antex_app_server_protocol::WarningNotification;
use antex_app_server_protocol::build_item_from_guardian_event;
use antex_app_server_protocol::guardian_auto_approval_review_notification;
use antex_app_server_protocol::item_event_to_server_notification;
use antex_core::AntexThread;
use antex_core::ThreadManager;
use antex_features::Feature;
use antex_guardian_v2::StrictReviewReason;
use antex_protocol::ThreadId;
use antex_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use antex_protocol::items::TurnItem as CoreTurnItem;
use antex_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use antex_protocol::plan_tool::UpdatePlanArgs;
use antex_protocol::protocol::CodexErrorInfo as CoreAntexErrorInfo;
use antex_protocol::protocol::Event;
use antex_protocol::protocol::EventMsg;
use antex_protocol::protocol::ExecApprovalRequestEvent;
use antex_protocol::protocol::Op;
use antex_protocol::protocol::RealtimeEvent;
use antex_protocol::protocol::ReviewDecision;
use antex_protocol::protocol::SubAgentActivityKind;
...
use antex_protocol::protocol::TurnDiffEvent;
use antex_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use antex_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use antex_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use antex_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use antex_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use antex_shell_command::parse_command::shlex_join;
use antex_utils_absolute_path::AbsolutePathBuf;
use antex_utils_path_uri::LegacyAppPathString;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                antex_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                antex_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                antex_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                antex_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == antex_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                antex_protocol::protocol::GuardianAssessmentStatus::Denied
                | antex_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                antex_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                antex_protocol::protocol::GuardianAssessmentStatus::InProgress
                | antex_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: antex_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            if matches!(
                codex_error_info,
                Some(CoreAntexErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                ...
                message: ev.message,
                codex_error_info: ev.codex_error_info.map(V2AntexErrorInfo::from),
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: antex_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: antex_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<AntexThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: antex_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            antex_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use antex_app_server_protocol::AutoReviewDecisionSource;
    use antex_app_server_protocol::GuardianApprovalReviewStatus;
    use antex_app_server_protocol::JSONRPCErrorError;
    use antex_app_server_protocol::ServerRequest;
    use antex_app_server_protocol::TurnPlanStepStatus;
    use antex_login::AntexAuth;
    use antex_protocol::AgentPath;
    use antex_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use antex_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use antex_protocol::items::DynamicToolCallItem;
    use antex_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use antex_protocol::items::SubAgentActivityItem;
    use antex_protocol::items::TurnItem as CoreTurnItem;
    use antex_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use antex_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    use antex_protocol::models::PermissionProfile;
    use antex_protocol::plan_tool::PlanItemArg;
    use antex_protocol::plan_tool::StepStatus;
    use antex_protocol::protocol::AgentMessageEvent;
    use antex_protocol::protocol::AskForApproval;
    use antex_protocol::protocol::AuthRecoveryEvent;
    use antex_protocol::protocol::CreditsSnapshot;
    use antex_protocol::protocol::EventMsg;
    use antex_protocol::protocol::GuardianAssessmentEvent;
    use antex_protocol::protocol::GuardianAssessmentStatus;
    use antex_protocol::protocol::ItemCompletedEvent;
    use antex_protocol::protocol::ItemStartedEvent;
    ...
    use antex_thread_store::StoredThreadHistory;
    use antex_utils_absolute_path::AbsolutePathBuf;
    use antex_utils_absolute_path::test_support::PathBufExt;
    use antex_utils_absolute_path::test_support::test_path_buf;
    use anyhow::Result;
    use anyhow::anyhow;
    use anyhow::bail;
    use chrono::Utc;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: antex_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(antex_protocol::protocol::GuardianRiskLevel::Low),
                Some(antex_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(antex_protocol::protocol::GuardianRiskLevel::High),
                Some(antex_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(antex_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = antex_protocol::protocol::GuardianAssessmentAction::Command {
            source: antex_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: antex_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: antex_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(antex_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(antex_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    antex_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(antex_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(antex_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = antex_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: antex_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: antex_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            antex_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let thread_manager = Arc::new(
            antex_core::test_support::thread_manager_with_models_provider_and_home(
                AntexAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.codex_home.to_path_buf(),
                Arc::new(antex_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let antex_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(antex_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codex_error_info: Some(V2AntexErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(antex_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(antex_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(antex_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let antex_core::NewThread {
            ...
            .start_thread(antex_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: antex_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codex_error_info: Some(V2AntexErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codex_error_info: Some(V2AntexErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
