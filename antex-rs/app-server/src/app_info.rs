use antex_app_server_protocol::AppBranding as ApiAppBranding;
use antex_app_server_protocol::AppInfo as ApiAppInfo;
use antex_app_server_protocol::AppMetadata as ApiAppMetadata;
use antex_app_server_protocol::AppReview as ApiAppReview;
use antex_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use antex_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use antex_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use antex_connectors::AppBranding;
use antex_connectors::AppInfo;
use antex_connectors::AppMetadata;
use antex_connectors::AppReview;
use antex_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `antex-connectors` into the app-server wire
/// type owned by `antex-app-server-protocol`.
///
