...
use antex_login::default_client::SetOriginatorError;
...
const NON_ORIGINATING_CLIENT_NAMES: &[&str] = &["antex_app_server_daemon", "codex-backend"];
...
impl InitializeRequestProcessor {
    ...
    pub(crate) async fn initialize(
        ...
        let client_mcp_extensions = antex_mcp::client_mcp_extensions(
            extensions,
            ...
            if let Err(error) = set_default_originator(originator.clone()) {
                match error {
                    ...
                    SetOriginatorError::AlreadyInitialized => {
                        ...
                        // TODO(owen): Once we remove support for ANTEX_INTERNAL_ORIGINATOR_OVERRIDE,
        ...
        let user_agent = get_antex_user_agent();
