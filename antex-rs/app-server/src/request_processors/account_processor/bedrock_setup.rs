...
use antex_app_server_protocol::AwsCredentialType;
use antex_app_server_protocol::BedrockAwsProfile;
use antex_app_server_protocol::BedrockDiscoverParams;
use antex_app_server_protocol::BedrockDiscoverResponse;
use antex_app_server_protocol::BedrockEnvironmentCredential;
use antex_app_server_protocol::BedrockSetupParams;
use antex_app_server_protocol::BedrockSetupResponse;
...
impl AccountRequestProcessor {
    pub(crate) async fn bedrock_discover(
        ...
        let profiles = antex_aws_auth::discover_aws_profiles()
            .await
    ...
    pub(crate) async fn bedrock_setup(
        ...
        let profile = match &params {
            BedrockSetupParams::Profile { profile, .. } => {
                ...
                antex_aws_auth::validate_aws_profile(profile, region)
                    .await
                    .map_err(|err| {
