...
use antex_app_server_protocol::Project;
use antex_app_server_protocol::ProjectChangeType;
use antex_app_server_protocol::ProjectChangedNotification;
use antex_app_server_protocol::ProjectCreateParams;
use antex_app_server_protocol::ProjectCreateResponse;
use antex_app_server_protocol::ProjectDeleteParams;
use antex_app_server_protocol::ProjectDeleteResponse;
use antex_app_server_protocol::ProjectImportParams;
use antex_app_server_protocol::ProjectImportResponse;
use antex_app_server_protocol::ProjectListParams;
use antex_app_server_protocol::ProjectListResponse;
use antex_app_server_protocol::ProjectMoveParams;
use antex_app_server_protocol::ProjectMoveResponse;
use antex_app_server_protocol::ProjectReadParams;
use antex_app_server_protocol::ProjectReadResponse;
use antex_app_server_protocol::ProjectRoot;
use antex_app_server_protocol::ProjectSortKey;
use antex_app_server_protocol::ProjectUpdateParams;
use antex_app_server_protocol::ProjectUpdateResponse;
...
use antex_thread_store::CreateProjectParams as StoreCreateProjectParams;
use antex_thread_store::ListProjectsParams as StoreListProjectsParams;
use antex_thread_store::MoveProjectParams as StoreMoveProjectParams;
use antex_thread_store::ProjectMoveOutcome;
use antex_thread_store::ProjectSortKey as StoreProjectSortKey;
use antex_thread_store::SortDirection as StoreSortDirection;
use antex_thread_store::StoredProject;
use antex_thread_store::StoredProjectRoot;
use antex_thread_store::ThreadStore;
use antex_thread_store::ThreadStoreError;
use antex_thread_store::UpdateProjectParams as StoreUpdateProjectParams;
...
fn validate_roots(roots: Vec<ProjectRoot>) -> Result<Vec<StoredProjectRoot>, JSONRPCErrorError> {
    ...
    roots
        .into_iter()
        .map(|root| {
            let path = antex_utils_absolute_path::AbsolutePathBuf::from_absolute_path_checked(
...
fn api_project(project: StoredProject) -> Result<Project, JSONRPCErrorError> {
    Ok(Project {
        ...
        roots: project
            ...
            .map(|root| {
                Ok(ProjectRoot {
                    path: antex_utils_absolute_path::AbsolutePathBuf::from_absolute_path(root.path)
                        .map_err(|error| {
