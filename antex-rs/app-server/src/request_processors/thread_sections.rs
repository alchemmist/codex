...
use antex_app_server_protocol::ThreadSectionCreateResponse;
use antex_app_server_protocol::ThreadSectionDeleteParams;
use antex_app_server_protocol::ThreadSectionDeleteResponse;
use antex_app_server_protocol::ThreadSectionListParams;
use antex_app_server_protocol::ThreadSectionListResponse;
use antex_app_server_protocol::ThreadSectionUpdateParams;
use antex_app_server_protocol::ThreadSectionUpdateResponse;
use antex_state::PINNED_THREAD_SECTION_ID;
use antex_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use antex_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use antex_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use antex_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
use antex_thread_store::StoredThreadSection;
...
fn state_thread_section_appearance(
    appearance: ThreadSectionAppearance,
) -> antex_state::ThreadSectionAppearance {
    antex_state::ThreadSectionAppearance {
        icon: appearance.icon,
        color: appearance.color,
    }
