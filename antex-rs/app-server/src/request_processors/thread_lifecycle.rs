...
pub(super) async fn wait_for_thread_shutdown(thread: &Arc<AntexThread>) -> ThreadShutdownResult {
...
fn merge_active_turn_into_page(
    page: &mut antex_app_server_protocol::TurnsPage,
    mut active_turn: Turn,
    params: &antex_app_server_protocol::ThreadResumeInitialTurnsPageParams,
) {
