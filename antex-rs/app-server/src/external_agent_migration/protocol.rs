...
use antex_app_server_protocol::CommandMigration;
...
use antex_app_server_protocol::ExternalAgentConfigImportHistory;
...
use antex_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use antex_app_server_protocol::ExternalAgentDetectedConnectorSource;
use antex_app_server_protocol::HookMigration;
use antex_app_server_protocol::JSONRPCErrorError;
use antex_app_server_protocol::McpServerMigration;
use antex_app_server_protocol::MigrationDetails;
use antex_app_server_protocol::PluginsMigration;
use antex_app_server_protocol::SkillMigration;
use antex_app_server_protocol::SubagentMigration;
use antex_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use antex_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use antex_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use antex_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use antex_external_agent_migration::ExternalAgentConfigImportSuccess;
use antex_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use antex_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use antex_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use antex_external_agent_migration::NamedMigration;
use antex_external_agent_migration::PluginsMigration as CorePluginsMigration;
use antex_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| antex_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: antex_state::ExternalAgentConfigImportHistoryRecord,
