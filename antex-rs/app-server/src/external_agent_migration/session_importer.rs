...
use antex_external_agent_migration::ExternalAgentConfigImportItemResult;
use antex_external_agent_migration::record_import_error;
use antex_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use antex_external_agent_migration::sessions::ExistingSessionAppend;
use antex_external_agent_migration::sessions::ExternalAgentSessionMigration;
use antex_external_agent_migration::sessions::ImportedExternalAgentSession;
use antex_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use antex_external_agent_migration::sessions::PendingSessionImport;
use antex_external_agent_migration::sessions::SessionImportTarget;
use antex_external_agent_migration::sessions::SessionMetadataMode;
use antex_external_agent_migration::sessions::append_existing_session;
use antex_external_agent_migration::sessions::append_imported_session_connector_names;
use antex_external_agent_migration::sessions::detect_imported_cla_session_connectors_by_source_path;
use antex_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use antex_external_agent_migration::sessions::record_completed_session_imports;
...
impl ExternalAgentSessionImporter {
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: antex_login::default_client::originator().value,
