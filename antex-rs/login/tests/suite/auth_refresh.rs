...
use antex_login::token_data::IdTokenInfo;
...
const SYSTEM_PROXY_TEST_SUBPROCESS_ENV_VAR: &str = "ANTEX_AUTH_SYSTEM_PROXY_TEST_SUBPROCESS";
const SYSTEM_PROXY_TEST_PROXY_URL_ENV_VAR: &str = "ANTEX_AUTH_SYSTEM_PROXY_TEST_PROXY_URL";
...
async fn refresh_token_honors_respect_system_proxy() -> Result<()> {
    ...
    let auth_manager = AuthManager::shared(
        ...
        /*auth_route_config*/
        antex_login::AuthRouteConfig::from_http_client_factory(HttpClientFactory::new(
