...
async fn test_create_client_sets_default_headers() {
    ...
    // User-Agent matches the computed Antex UA for that originator
    let expected_ua = get_antex_user_agent();
