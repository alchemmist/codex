...
use antex_otel::AuthEnvTelemetryMetadata;

use crate::ANTEX_API_KEY_ENV_VAR;
...
pub struct AuthEnvTelemetry {
    ...
    pub antex_api_key_env_present: bool,
    pub antex_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            antex_api_key_env_present: self.antex_api_key_env_present,
            antex_api_key_env_enabled: self.antex_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    antex_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        antex_api_key_env_present: env_var_present(ANTEX_API_KEY_ENV_VAR),
        antex_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*antex_api_key_env_enabled*/ false);
