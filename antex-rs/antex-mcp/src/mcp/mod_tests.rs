...
pub(crate) fn test_mcp_config(codex_home: PathBuf) -> McpConfig {
    McpConfig {
        ...
        config_layer_stack: antex_config::ConfigLayerStack::default(),
        approvals_reviewer: antex_config::types::ApprovalsReviewer::default(),
        ...
        connector_snapshot: antex_connectors::ConnectorSnapshot::default(),
    }
}
