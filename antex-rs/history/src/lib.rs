...
pub struct ResponseItemEnvelope {
    ...
    pub metadata: Option<AntexHarnessMetadata>,
}

/// Metadata owned by the Antex harness and persisted with a response item.
///
#[derive(Serialize, Deserialize, Debug, Clone, Default, PartialEq, Eq, JsonSchema)]
pub struct AntexHarnessMetadata {
    ...
    /// Whether a response configuration update was created by the Antex harness itself.
...
/// antex_rollout's canonical parser so nested decimal values survive the flattened envelope.
