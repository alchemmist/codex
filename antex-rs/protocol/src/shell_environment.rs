...
pub const ANTEX_SESSION_ID_ENV_VAR: &str = "ANTEX_SESSION_ID";
pub const ANTEX_THREAD_ID_ENV_VAR: &str = "ANTEX_THREAD_ID";
pub const ANTEX_EXEC_SERVER_NOISE_AUTH_TOKEN_ENV_VAR: &str = "ANTEX_EXEC_SERVER_NOISE_AUTH_TOKEN";
...
///
/// This prevents accidental propagation of Antex launch context; it is not a
    ...
    I: IntoIterator<Item = (String, String)>,
{
    ...
    if let Some(thread_id) = thread_id {
        env_map.insert(ANTEX_THREAD_ID_ENV_VAR.to_string(), thread_id.to_string());
        env_map.insert("CODEX_THREAD_ID".to_string(), thread_id.to_string());
    }
