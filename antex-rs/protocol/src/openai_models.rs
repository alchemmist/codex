//! Shared model metadata types exchanged between Antex services and clients.
//!
...
/// Metadata describing a Antex-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Antex backend `/models` endpoint.
