...
```rust
use antex_utils_stream_parser::CitationStreamParser;
use antex_utils_stream_parser::StreamTextParser;
...
```rust
use antex_utils_stream_parser::CitationStreamParser;
use antex_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), antex_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use antex_utils_stream_parser::InlineHiddenTagParser;
use antex_utils_stream_parser::InlineTagSpec;
use antex_utils_stream_parser::StreamTextParser;
