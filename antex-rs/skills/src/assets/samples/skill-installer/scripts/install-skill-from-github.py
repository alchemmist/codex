#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into $ANTEX_HOME/skills."""
...
def _antex_home() -> str:
    return os.environ.get("ANTEX_HOME", os.path.expanduser("~/.antex"))
...
def _default_dest() -> str:
    return os.path.join(_antex_home(), "skills")
