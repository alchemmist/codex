...
Set a stable path to the skill CLI (default `ANTEX_HOME` is `~/.antex`):

```
export ANTEX_HOME="${ANTEX_HOME:-$HOME/.antex}"
export IMAGE_GEN="$ANTEX_HOME/skills/.system/imagegen/scripts/image_gen.py"
```
