...
/// Returns the on-disk cache location for embedded system skills from an absolute ANTEX_HOME.
...
/// Installs embedded system skills into `ANTEX_HOME/skills/.system`.
///
