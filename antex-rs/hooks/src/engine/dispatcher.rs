...
pub(crate) fn completed_summary(
    ...
    entries: Vec<antex_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    let HandlerSourcePath::Local(source_path) = &handler.source_path else {
        unreachable!("executor-scoped hooks do not produce public hook summaries");
    };
...
pub(crate) fn hook_source_label(source: antex_protocol::protocol::HookSource) -> &'static str {
    match source {
        antex_protocol::protocol::HookSource::System => "system",
        antex_protocol::protocol::HookSource::User => "user",
        antex_protocol::protocol::HookSource::Project => "project",
        antex_protocol::protocol::HookSource::Mdm => "mdm",
        antex_protocol::protocol::HookSource::SessionFlags => "session_flags",
        antex_protocol::protocol::HookSource::Plugin => "plugin",
        antex_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        antex_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        antex_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        antex_protocol::protocol::HookSource::LegacyManagedConfigMdm => "legacy_managed_config_mdm",
        antex_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
