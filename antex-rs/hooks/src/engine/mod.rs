...
use antex_protocol::protocol::HookTrustStatus;
...
pub(crate) struct ConfiguredHandler {
    ...
    pub builtin: bool,
    pub event_name: antex_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            antex_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            antex_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            antex_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            antex_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            antex_protocol::protocol::HookEventName::PostCompact => "post-compact",
            antex_protocol::protocol::HookEventName::SessionStart => "session-start",
            antex_protocol::protocol::HookEventName::SessionEnd => "session-end",
            antex_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            antex_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            antex_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            antex_protocol::protocol::HookEventName::Stop => "stop",
            antex_protocol::protocol::HookEventName::Interrupt => "interrupt",
        }
    }
