...
impl Hooks {
    ...
    ) -> anyhow::Result<(Self, Receiver<antex_protocol::protocol::HookCompletedEvent>)> {
    ...
    ) -> Vec<antex_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_session_end(&self) -> Vec<antex_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_interrupt(&self) -> Vec<antex_protocol::protocol::HookRunSummary> {
